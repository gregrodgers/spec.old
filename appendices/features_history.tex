...
\item Runtime routines and environment variables were added to provide OpenMP runtime
      thread affinity information.  The added runtime routines include 
      \code{omp_set_affinity_format}, \code{omp_get_affinity_format}, 
      ...
      and \specref{subsec:omp_capture_affinity}). 
      The added environment variables include \code{OMP_DISPLAY_AFFINITY} and 
      \code{OMP_AFFINITY_FORMAT} (see \specref{sec:OMP_DISPLAY_AFFINITY} and 
