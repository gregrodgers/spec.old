...
\item Predefined memory allocators (see \specref{sec:Memory Allocators}) and
      directives, clauses (see \specref{sec:Memory Management Directives} and
      API routines (see \specref{sec:Memory Management Routines}) to use them
