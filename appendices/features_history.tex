...
\item The \code{independent} construct was added to enable programmers to make
  assertions about the independence of loop iterations (see
    \specref{sec:independent Construct}).
