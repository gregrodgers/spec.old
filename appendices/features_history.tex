...
\item The \code{omp_set_nested} (see \specref{subsec:omp_set_nested}) and
      ...
      the \code{OMP_NESTED} environment variable (see
      \specref{sec:OMP_NESTED}) were deprecated.
...
\item Runtime routines \code{omp_set_affinity_format}, \code{omp_get_affinity_format},
      \code{omp_set_affinity}, and \code{omp_capture_affinity}
      (see \specref{subsec:omp_set_affinity_format},
      \specref{subsec:omp_get_affinity_format}, \specref{subsec:omp_display_affinity},
      and \specref{subsec:omp_capture_affinity}) and environment variables
      \code{OMP_DISPLAY_AFFINITY} and \code{OMP_AFFINITY_FORMAT} (see
      \specref{sec:OMP_DISPLAY_AFFINITY} and \specref{sec:OMP_AFFINITY_FORMAT})
