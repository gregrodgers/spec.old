...
\begin{itemize}
\item The \code{omp_all_memory} \plc{reserved item locator} was added (see \specref{sec:Directive Format}),
      and the \code{depend} clause allows its use (see \specref{subsec:depend Clause}).
