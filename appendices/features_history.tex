...
\item Predefined memory spaces (see \specref{subsec:Memory Spaces}), predefined memory allocators 
      and allocator traits (see \specref{subsec:Memory Allocators}) and
...
\item Replaced incorrect use of \code{omp_integer_kind} in Fortran interfaces (see
