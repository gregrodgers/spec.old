...
\item The description of the map clause was modified to clarify how structure
members are mapped. (See Section XX on page XX).

\item The capability to map pointer variables and assign them the address of
device memory that is mapped by an array section was added (See Section
XX on page XX).
