...
\begin{itemize}
\item The \plc{nest-var} ICV, \code{OMP\_NESTED} environment variable, and the \code{omp\_set\_nested} and \code{omp\_get\_nested} routines.
\end{itemize}
...
\item The default value of the \plc{nest-var} ICV was changed from \plc{false} to implementation defined.
The \plc{nest-var} ICV, the \code{OMP\_NESTED} environment variable, and the \code{omp\_set\_nested} and \code{omp\_get\_nested} routines were deprecated.
