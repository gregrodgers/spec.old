...
\item Support for array shaping (see \specref{sec:Array Shaping}) and 
      ...
      \specref{subsec:target update Construct}), the \code{depend} clause 
      (see \specref{subsec:depend Clause}) and the \code{affinity} clause 
      (see \specref{subsec:task Construct}) were extended to allow the use 
