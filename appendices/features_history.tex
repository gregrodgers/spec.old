...
\begin{itemize}
\item Predefined memory allocators were added to support different kinds of memories (see \specref{sec:Memory Allocators}). Directives, clauses and API routines to use them were also added (see \specref{sec:sec:Memory Management Directives} and \specref{sec:Memory Management Routines}).
