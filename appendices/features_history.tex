...
\item C++ attribute specifier was added to directives (see \specref{sec:Directive Format}).

\item Support for declare SIMD using attribute specifier was added (see \specref{subsubsec:Declare SIMD Directive}).
