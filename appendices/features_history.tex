...
\item The \code{inscan} and \code{notinscan} modifiers were added to
    \code{reduction} clause to support the \plc{inclusive} and \plc{exclusive}
    scan computation (see \specref{subsubsec:reduction clause}).  The
    \code{scan} directive was added to support \plc{inclusive} and
    \plc{exclusive} scan computation (see \specref{sec:scan Directive}).
