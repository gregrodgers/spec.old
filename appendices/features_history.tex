...
\item Support for array shaping (see \specref{sec:Array Shaping}) and 
      ...
      specification of discontiguous storage and the \code{target update} 
      construct (see \specref{subsec:target update Construct}) was modified 
      to allow array sections that specify discontiguous storage.
