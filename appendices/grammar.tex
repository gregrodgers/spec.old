% This is grammar.tex (deprecated and removed) of the OpenMP specification.
...
\C\I {\rmfamily\bfseries\upshape\small /* Any C or C++ declaration or definition statement */}

\G\I function-statement:

\C\I {\rmfamily\bfseries\upshape\small /* C or C++ function definition or declaration */}
...
\I openmp-simple-construct

\I openmp-composite-construct

\I openmp-combined-construct

openmp-simple-construct:
...
\I target-parallel-construct

\I target-parallel-for-construct

\I target-parallel-for-simd-construct

\I target-simd-construct
...
\I target-parallel-directive structured-block

target-parallel-directive:

\C\I \#pragma omp target parallel \G target-parallel-clause$_{optseq}$ new-line
...
\I target-parallel-for-directive iteration-statement

target-parallel-for-directive:

\C\I \#pragma omp target parallel for \G target-parallel-for-clause$_{optseq}$ new-line

target-parallel-for-clause:
...
\I target-parallel-for-simd-directive iteration-statement

target-parallel-for-simd-directive:
 
\C\I \#pragma omp target parallel for simd \G target-parallel-for-simd-clause$_{optseq}$ new-line
...
\I target-simd-directive iteration-statement

target-simd-directive:
 
\C\I \#pragma omp target simd \G target-simd-clause$_{optseq}$ new-line
