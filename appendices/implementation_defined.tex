...
of the size of \emph{x}), then the behavior of the atomic region is implementation defined (see \specref{subsec:atomic Construct}).
...
\implcallback{ompt_callback_dependences}
