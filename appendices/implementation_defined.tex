...
\item \textbf{Memory allocators}: The storage resource that will be used by each memory allocator defined in \tabref{tab:Memory Allocators} is implementation defined.
