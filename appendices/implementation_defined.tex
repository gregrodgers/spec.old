...
\item \textbf{Teams construct}: the assignment of initial threads to places (see \specref{sec:Execution Model}) and the value of the \plc{place-partition-var} ICV for each initial thread (see \specref{sec:teams Construct}) are implementation defined.
