...
! this selects an integer that is large enough to hold a 32 bit integer
     ...
     & )
      ...
      integer omp_pause_kind
      parameter ( omp_pause_kind = selected_int_kind( 8 ) )
      integer ( omp_pause_kind ) omp_pause_soft
      parameter ( omp_pause_soft = 1 )
      integer ( omp_pause_kind ) omp_pause_hard
...
!23456
      ...
      &   omp_proc_bind_spread = 4
        ...
        integer, parameter :: omp_pause_kind = selected_int_kind( 8 )
        integer (kind=omp_pause_kind), parameter :: omp_pause_soft = 1
        integer (kind=omp_pause_kind), parameter :: omp_pause_hard = 2
