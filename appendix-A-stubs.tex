...
void omp\_init\_lock\_hinted(omp\_lock\_t *arg, omp\_lock\_hint\_t hint)
\{
    omp\_init\_lock(arg);
\}
...
void omp\_init\_nest\_lock\_hinted(omp\_nest\_lock\_t *arg, omp\_lock\_hint\_t hint)
\{
...
subroutine omp\_init\_lock\_hint\_hinted(lock, hint)
  include 'omp\_lib\_kinds.h'
  integer(kind=omp\_lock\_kind) lock
...
subroutine omp\_init\_nest\_lock\_hinted(nlock)
  include 'omp\_lib\_kinds.h'
  integer(kind=omp\_nest\_lock\_kind) nlock
  integer(kind=omp\_lock\_hint\_kind) hint
