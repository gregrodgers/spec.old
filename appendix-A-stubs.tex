...
int function omp\_tool\_control(command, modifier)
  include 'omp\_lib\_kinds.h'
  integer (kind=omp\_tool\_control\_kind) command
  integer (kind=omp\_tool\_control\_kind) modifier

  return omp\_tool\_control\_notool
end function
\end{codepar}} % end \small block
