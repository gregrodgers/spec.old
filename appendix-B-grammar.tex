...
\G declarations-definitions-seq:

\I declaration-definition

\I declarations-definitions-seq declaration-definition
...
\C\I \# pragma omp target update \G target-update-clause$_{seq}$ new-line
...
\I declare-target-directive declarations-definitions-seq end-declare-target-directive
...
\I depend ( \G dependence-type \C :\G variable-array-section-list \C )
