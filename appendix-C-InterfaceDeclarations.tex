 ...
 */
typedef omp\_tool\_control\_t 
\{
  omp\_tool\_control\_start = 1,
  omp\_tool\_control\_pause = 2,
  omp\_tool\_control\_flush = 3,
  omp\_tool\_control\_end = 4,
\} omp\_tool\_control\_t;
\end{samepage}
/*
...
extern void omp\_tool\_control(int command, int modifier, void *arg);
...
{\small \begin{codepar}
     ...
     integer omp\_tool\_control\_kind
     integer omp\_tool\_control\_result\_kind
...
\begin{samepage}
     parameter ( omp\_tool\_control\_kind = selected\_int\_kind( 8 ) )
     integer ( omp\_tool\_control\_kind ) omp\_tool\_control\_start 
     parameter ( omp\_tool\_control\_start = 1 )
     integer ( omp\_tool\_control\_kind ) omp\_tool\_control\_pause 
     parameter ( omp\_tool\_control\_pause = 2 )
     integer ( omp\_tool\_control\_kind ) omp\_tool\_control\_flush 
     parameter ( omp\_tool\_control\_flush = 3 )
     integer ( omp\_tool\_control\_kind ) omp\_tool\_control\_end 
     parameter ( omp\_tool\_control\_end = 4 )
\end{samepage}
\begin{samepage}
     parameter ( omp\_tool\_control\_result\_kind = selected\_int\_kind( 8 ) )
     integer ( omp\_tool\_control\_result\_kind ) omp_tool_control_notool 
     parameter ( omp_tool_control_notool = -2 )
     integer ( omp\_tool\_control\_result\_kind ) omp_tool_control_nocallback
     parameter ( omp_tool_control_nocallback = -1 )
     integer ( omp\_tool\_control\_result\_kind ) omp_tool_control_success
     parameter ( omp_tool_control_success = 0 )
     integer ( omp\_tool\_control\_result\_kind ) omp_tool_control_ignored 
     parameter ( omp_tool_control_ignored = 1 )
\end{samepage}
\end{codepar}}
...
! OpenMP API v4.5
     ...
     parameter ( openmp\_version = 201511 )
...
!23456
      ...
      \&   omp\_proc\_bind\_spread = 4
\begin{samepage}
        integer, parameter :: omp\_tool\_control\_kind = selected\_int\_kind( 8 )
        integer (kind=omp\_tool\_control\_kind), parameter :: 
      \&   omp\_tool\_control\_start = 1
        integer (kind=omp\_tool\_control\_kind), parameter :: 
      \&   omp\_tool\_control\_pause = 2
        integer (kind=omp\_tool\_control\_kind), parameter :: 
...
\end{samepage}
\begin{samepage}
        integer, parameter ( omp\_tool\_control\_result\_kind = selected\_int\_kind( 8 ) )
        integer ( omp\_tool\_control\_result\_kind ), parameter :: 
...
!                                     OpenMP API v4.5
          integer, parameter :: openmp\_version = 201511
...
\begin{samepage}
          function omp\_tool\_control (command, modifier)
           use omp\_lib\_kinds
           integer :: omp\_tool\_control 
           integer(kind=omp\_tool\_control\_kind), intent(in) :: command
           integer(kind=omp\_tool\_control\_kind), intent(in) :: modifier
          end function omp\_tool\_control
\end{samepage}
          end interface
