 ...
 */
typedef omp\_tcontrol\_t \{
  omp\_tcontrol\_start = 1,
  omp\_tcontrol\_pause = 2,
  omp\_tcontrol\_flush = 3,
  omp\_tcontrol\_end = 4,
\} omp\_tcontrol\_t;
\end{samepage}
/*
...
extern void omp\_tcontrol(long long int command, long long int modifier);
...
\begin{samepage}
     integer omp\_tcontrol\_kind
! this selects an integer that is large enough to hold a 64 bit integer
     parameter ( omp\_tcontrol\_kind = selected\_int\_kind( 10 ) )
     integer ( omp\_tcontrol\_kind ) omp\_tcontrol\_start 
     parameter ( omp\_tcontrol\_start = 1 )
     integer ( omp\_tcontrol\_kind ) omp\_tcontrol\_pause 
     parameter ( omp\_tcontrol\_pause = 2 )
     integer ( omp\_tcontrol\_kind ) omp\_tcontrol\_flush 
     parameter ( omp\_tcontrol\_flush = 3 )
     integer ( omp\_tcontrol\_kind ) omp\_tcontrol\_end 
...
\begin{samepage}
        integer, parameter :: omp\_tcontrol\_kind = selected\_int\_kind( 10 )
...
\begin{samepage}
          subroutine omp\_tcontrol (command, modifier)
           use omp\_lib\_kinds
           integer(kind=omp\_tcontrol\_kind), intent(in) :: command
           integer(kind=omp\_tcontrol\_kind), intent(in) :: modifier
          end subroutine omp\_tcontrol
\end{samepage}
          end interface
