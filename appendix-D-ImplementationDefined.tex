...
\item \textbf{Data-sharing attributes}: It is implementation-defined whether
dummy arguments without the \code{VALUE} attribute have the same data-sharing
attributes as their associated actual arguments or are private, except for the
conditions specified (see
