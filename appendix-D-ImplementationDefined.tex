...
\item \textbf{Data-sharing attributes}: Data-sharing attributes of dummy
arguments depend on whether temporary storage is used in place of the actual
argument on the procedure reference. The use of temporary storage is
implementation-defined, except for the conditions specified (see
\specref{subsubsec:Data-sharing Attribute Rules for Variables Referenced in a
