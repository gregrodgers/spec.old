...
\item The \code{target enter data} (see \specref{subsec:target enter data 
      ...
      (see \specref{subsec:map Clause}) was updated to support unstructured 
      data mapping for devices. 
