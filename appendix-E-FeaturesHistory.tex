...
\label{sec:Version 4.5 to 4.5 Differences}
\begin{itemize} \item To support task reductions, the \code{task\_reduction}
...
\item To support taskloop reductions, the \code{reduction} and \code{in\_reduction} clauses were added to the \code{taskloop} and \code{taskloop simd} constructs.
\end{itemize}
