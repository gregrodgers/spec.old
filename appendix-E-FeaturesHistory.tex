...
\begin{itemize}
\item Taskloop constructs (see \specref{subsec:taskloop Construct} and \specref{subsec:taskloop simd Construct}) were added to support nestable parallel loops that created OpenMP tasks. 
\end{itemize}
...
\specref{subsubsec:depend Clause}) 
