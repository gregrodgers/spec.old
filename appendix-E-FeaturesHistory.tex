...
\begin{itemize}
\item Several limitations on support for Fortran 2003 
      (see \specref{sec:normative references}) were removed.
...
\item Semantics for reductions on C/C++ array sections were added and 
      restrictions on use of arrays and pointers in reductions were 
