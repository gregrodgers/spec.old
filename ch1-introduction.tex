...
\glossarydefstart
A  \emph{entry point} used to inquire about the states or mutual exclusion implementations supported by 
...
OpenMP implementations may differ with respect to the thread states that
