...
\glossarydefstart
One or more user frames associated with a task \plc{t} followed by a sequence of one or 
OpenMP runtime frames that appear on the stack immediately above another user frame also associated with task \plc{t}.
\glossarydefend
