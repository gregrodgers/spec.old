...
\glossarydefstart
A structure is a variable that contains one or more variables. Structures are implemented using structs in C or C++, classes in C++, and derived type in Fortran.
\glossarydefend
