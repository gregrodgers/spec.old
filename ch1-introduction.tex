...
\glossarydefstart
An \emph{implementation defined} representation of the address of a block of storage
in a \emph{device data environment}.
\glossarydefend

\glossaryterm{device pointer}
\glossarydefstart
A \emph{variable} in one \emph{device data environment} that contains an
\emph{implementation defined} representation of a \emph{device address} in a
different \emph{device data environment}.
\glossarydefend
