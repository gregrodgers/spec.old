...
\glossarydefstart
A \emph{trace record} for an OpenMP device that is in a device-specific format defined by a third party.
\glossarydefend
...
\glossarydefstart
A data structure to store the information of an \emph{event}.
\glossarydefend
