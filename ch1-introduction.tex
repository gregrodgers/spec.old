...
\glossarydefstart
A \emph{construct} (lexically) enclosed by another \emph{construct}, or a
\emph{construct} for which the encountering thread's innermost \emph{region} is
nested inside another \emph{region}.
\glossarydefend
...
between them, or a \emph{construct} for which the encountering thread's
innermost \emph{region} is nested inside another \emph{region} with no other \emph{region}
nested between them.
\glossarydefend
