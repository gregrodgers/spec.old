...
For Fortran:
\nopagebreak
A scalar variable with intrinsic type, excluding character type.
\glossarydefend
...
\glossarydefstart
A structure is a variable that contains one or more variables. Structures are implemented using structs in C or C++, classes in C++, and structured user types in Fortran.
\glossarydefend
