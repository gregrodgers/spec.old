...
\glossaryterm{dispatch a callback} 
\glossarydefstart
Process a callback in a manner consistent with the return code
provided when a \emph{first-party} tool registers a callback.
\glossarydefend
...
to enforce mutual exclusion that may cause a thread to spin wait or suspend.
\glossarydefend
