...
\emph{construct} that is encountered during the execution of another
\emph{region}.
\glossarydefend
...
between them, or a \emph{construct} that is encountered during the execution
of another \emph{region} that is the innermost \emph{region} of the
encountering thread. 
\glossarydefend
