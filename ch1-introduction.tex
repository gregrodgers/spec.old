...
\glossaryterm{strict closely nested region}
\glossarydefstart
A \emph{region} inside another \emph{region} with no \code{parallel}, \code{team} or \code{target} \emph{region nested} between them. 
\glossarydefend
