...
\glossarydefstart
A structure is a variable that contains two or more variables. Structures are implemented using structs in C or C++, classes in C++, and structured user types in Fortran.
\glossarydefend
