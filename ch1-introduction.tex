...
\glossaryterm{native device pointer}
\glossarydefstart
A native pointer to memory in a device data environment.  These pointers are of the
native type used by a given target device, and should be used to inter-operate
with native functions.
\glossarydefend

\glossaryterm{OpenMP target pointer}
\glossarydefstart
An OpenMP pointer to memory in a device data environment for use with OpenMP
target runtime API functions.
\glossarydefend
