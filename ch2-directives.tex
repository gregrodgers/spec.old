...
original list item.  When the \code{conditional} modifier appears on the
clause, the final value written by the sequentially last iteration or lexically
last \code{section} construct that writes to a list item, if it exists, is
