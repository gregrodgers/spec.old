...
\code{parallel} construct before any implicit task is created by the
region.
...
after OpenMP is initialized for the device but before
beginning execution of any OpenMP construct on the device.

\tools 

A thread invokes a registered \code{ompt\_event\_device\_initialize}
