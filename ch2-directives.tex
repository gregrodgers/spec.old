...
The \code{depend} clause (\specref{subsec:depend Clause}), when used to specify task dependencies,
...
or a procedure name. A \plc{locator list item} is equivalent to a \plc{list item}.
