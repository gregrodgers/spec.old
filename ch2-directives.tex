...
actual arguments if the actual argument is a scalar variable, structure, or 
array or array section having contiguous storage.  Otherwise, it is
implementation-defined whether such dummy arguments have the same data-sharing
attributes as the associated actual arguments or are private.
