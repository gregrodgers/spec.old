...
\cppspecificstart
\item A variable that is part of another variable (as an array or structure element) cannot 
appear in a \code{shared} clause except if the \code{sharead} clause is associated with a construct within a class member function and the variable is a member of the same class or the variable is an accessible member of a base class.
\cppspecificend
