...
at the end of the binding region for which cancellation has been requested. If \plc{cancel-var} is \plc{false}, the \code{cancel} construct is 
ignored.
...
execution at the end of the binding region for which cancellation has been requested.
