...
Fortran has built-in support for array sections.
...
\item Any number of \code{reduction} clauses can be specified on the
  directive, but a list item (or any array element in an array
  section) can appear only once in the \code{reduction} clauses for
  that directive.
