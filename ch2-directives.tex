...
\descr
The \code{linear} clause provides a superset of the functionality provided by the private clause.
A list item that appears in a linear clause is subject to the private clause semantics described
in Section 2.15.3.3 on page 193 except as noted. If linear-step is not specified, it is assumed to be 1.
