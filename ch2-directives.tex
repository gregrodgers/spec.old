...
\item \code{ompt\_scoped\_worksharing\_callback\_t} type signature of the ordered
...
\item \code{ompt\_scoped\_worksharing\_callback\_t} type signature of the sections
begin and end callback, see 
\specref{sec:ompt_scoped_worksharing_callback_t}.
\end{itemize}
...
\item \code{ompt\_scoped\_worksharing\_callback\_t} type signature of the 
...
\crossreferences
\begin{itemize}
\item \code{ompt\_scoped\_worksharing\_callback\_t} type signature of the workshare
begin and end callback, see 
\specref{sec:ompt_scoped_worksharing_callback_t}.
\end{itemize}
...
\item \code{ompt\_scoped\_worksharing\_callback\_t} type signature of the distribute
begin and end callback, see 
\specref{sec:ompt_scoped_worksharing_callback_t}.
\end{itemize}
