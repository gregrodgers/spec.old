...
The \code{ompt\_event\_implicit\_task} callback executes in the context of the 
implicit \code{task} and has type signature \code{ompt\_implicit\_callback\_t}.
...
may invoke the callback \code{ompt\_event\_worksharing}, if registered, with
...
This callback has type signature \code{ompt\_worksharing\_callback\_t}.
...
\omptWorksharing{loop}{ompt\_worksharing\_loop}
...
\item \code{ompt\_worksharing\_callback\_t} type signature of the ordered
begin and end callback, see 
\specref{sec:ompt_worksharing_callback_t}.
...
\tools
\omptWorksharing{sections}{ompt\_worksharing\_sections}
...
\item \code{ompt\_worksharing\_callback\_t} type signature of the sections
begin and end callback, see 
\specref{sec:ompt_worksharing_callback_t}.
\end{itemize}
...
may invoke the callback \code{ompt\_event\_worksharing}, if registered, with
\code{endpoint=ompt\_scope\_begin} and \code{wstype=ompt\_worksharing\_single\_executor}.
The threads of the team which do not execute the \code{single} region may invoke 
the callback \code{ompt\_event\_worksharing}, if registered, with
\code{wstype=ompt\_worksharing\_single\_other}.
The encountering thread invokes this callback after an \code{implicit task} encounters a 
...
may invoke the callback \code{ompt\_event\_worksharing}, if registered, with
\code{endpoint=ompt\_scope\_end} and \code{wstype=ompt\_worksharing\_single\_executor}.
The threads of the team which do not execute the \code{single} region may invoke 
the callback \code{ompt\_event\_worksharing}, if registered, with
\code{wstype=ompt\_worksharing\_single\_other}.
The encountering thread invokes this callback 
...
\item \code{ompt\_worksharing\_callback\_t} type signature of the 
...
\tools
\omptWorksharing{workshare}{ompt\_worksharing\_workshare}
...
\crossreferences
\begin{itemize}
\item \code{ompt\_worksharing\_callback\_t} type signature of the workshare
begin and end callback, see 
\specref{sec:ompt_worksharing_callback_t}.
\end{itemize}
...
\toolsToDo{No tools paragraph needed for \code{taskloop}?}
...
\tools
\omptWorksharing{distribute}{ompt\_worksharing\_distribute}
...
\item \code{ompt\_worksharing\_callback\_t} type signature of the distribute
begin and end callback, see 
\specref{sec:ompt_worksharing_callback_t}.
\end{itemize}
