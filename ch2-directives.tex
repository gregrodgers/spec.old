...
an OpenMP implementation dispatches callback 
...
A thread dispatches a registered \code{ompt\_callback\_mutex\_release}
...
If the encountering thread dispatches the callback, it will occur before the consumer knows 
