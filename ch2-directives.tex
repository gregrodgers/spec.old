...
%\item If one or more elements of a structure appear in the map clauses of a \code{target} construct, 
%the \code{target} region may not refer to any other entries of that structure.
...
\item The \code{ref} or \code{uval} modifier can only be used if the \plc{list-item} is a dummy argument passed by reference.
