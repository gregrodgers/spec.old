...
\item The same list item must not appear both in a \code{to} clause on one
\code{declare}~\code{target} directive and in a \code{link} clause on
...
may be only specified within an implicit \plc{extended-list}.
\end{itemize}
\cppspecificend
