...
%The \plc{target task} is mergeable.  If the \code{nowait} clause is not present, the \plc{target task} is an included task.  If the \code{nowait} clause is present the current task may resume execution before the \plc{target task} is complete.
