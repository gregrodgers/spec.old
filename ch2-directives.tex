...
\code{teams} constructs, the expressions in \code{num\_teams} or
\code{thread\_limit} clauses are evaluated on the host device before
entering the \code{target} construct.
