...
evaluates to a valid lock hint (as described in~\ref{subsec:omp_init_lock_with_hint and omp_init_nest_lock_with_hint}).
...
which is a valid lock hint (as described in~\ref{subsec:omp_init_lock_with_hint and omp_init_nest_lock_with_hint}).
\fortranspecificend
...
\item If the \code{hint} clause is specified, each of the
  ...
  \code{hint} clause whose \plc{hint-expression} evaluates to the same
  value.
