...
\item A worksharing with a \code{reduction} clause over a certain list item cannot
appear in a taskgroup region that arises from a construct with a reduction
scoping clause over the same list item.
