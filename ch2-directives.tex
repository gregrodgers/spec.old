...
For any \code{in\_reduction} clause present on the \code{taskloop} construct, they behave as if they were applied to the generated tasks. Thus, the generated tasks are participants of a reduction previously defined by a reduction scoping clause.
