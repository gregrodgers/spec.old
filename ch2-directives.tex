...
When a thread is finishing an implicit task, an \plc{implicit-task-end} event
occurs in the thread after the implicit task executes its
...
\code{parallel} construct after the \code{parallel} region 
executes its closing synchronization barrier 
...
A thread invokes a registered \code{ompt\_parallel\_begin\_callback}
...
\code{ompt\_parallel\_begin\_callback\_t}.

A thread invokes a registered \code{ompt\_implicit\_callback\_task}
...
\code{ompt\_implicit\_task\_callback\_t}. The callback receives
\code{ompt\_scope\_begin} or \code{ompt\_scope\_end} 
as its \plc{endpoint} argument, as appropriate.

A thread invokes a registered \code{ompt\_parallel\_end\_callback}
callback for each occurrence of a \plc{parallel-end} event in that
thread.  The callback occurs in the task encountering
the parallel construct.  This callback has the type signature
\code{ompt\_parallel\_end\_callback\_t}.

A thread invokes a registered \code{ompt\_idle\_callback}
...
\code{ompt\_idle\_callback\_t}. The callback receives
\code{ompt\_scope\_begin} or \code{ompt\_scope\_end} 
as its \plc{endpoint} argument, as appropriate.

A thread invokes a registered \code{ompt\_thread\_begin\_callback}
...
\code{ompt\_thread\_begin\_callback\_t}. 

A thread invokes a registered \code{ompt\_thread\_end\_callback}
...
\code{ompt\_thread\_end\_callback\_t}. 
...
\item \code{ompt\_parallel\_begin\_callback\_t}, see
  \specref{sec:ompt_parallel_begin_callback_t}.

\item \code{ompt\_parallel\_end\_callback\_t}, 
  see \specref{sec:ompt_parallel_end_callback_t}.

\item \code{ompt\_implicit\_task\_callback\_t}, see
  \specref{sec:ompt_implicit_task_callback_t}.

\item \code{ompt\_thread\_begin\_callback\_t}, see
  \specref{sec:ompt_thread_begin_callback_t}.

\item \code{ompt\_thread\_end\_callback\_t}, see
  \specref{sec:ompt_thread_end_callback_t}.

\item \code{ompt\_idle\_callback\_t}, see 
\specref{sec:ompt_idle_callback_t}.
...
{
A thread invokes a registered \code{ompt\_target\_callback}
callback for each occurrence of a \plc{#1{-begin}} and
\plc{#1{-end}} event in that thread. The callback has type signature
\code{ompt\_target\_callback\_t}. The callback receives
\code{ompt\_scope\_begin} or \code{ompt\_scope\_end} 
as its \plc{endpoint} argument, as appropriate, and the
...
A thread invokes a registered \code{ompt\_mutex\_acquire\_callback}
callback for each occurrence of a \plc{#1-acquire} event 
in that thread.  This callback has the type signature \code{ompt\_mutex\_acquire\_callback\_t}.
A thread invokes a registered \code{ompt\_mutex\_acquired\_callback}
...
A thread invokes a registered \code{ompt\_mutex\_release\_callback}
...
A thread invokes a registered \code{ompt\_sync\_region\_callback}
...
\code{ompt\_sync\_region\_callback\_t}. The callback receives
