...
\ccppspecificstart
A \plc{list item} is a variable, an array section, or an \plc{lvalue}
expression that is not a variable. An \plc{extended list item} is a \plc{list
item} or a function name.  

An \plc{lvalue} expression that is not a variable can appear only in clauses
...
sections or \plc{lvalue} expressions that are not variables.
\ccppspecificend
