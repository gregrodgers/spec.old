...
Conditional execution of the target and/or conditional multi-threading of the \code{parallel}  can
be specified with the \plc{target:} and \plc{parallel:} \plc{directive-name} modifiers in the code{if} clause.
