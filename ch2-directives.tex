...
\item in one of the \verb#omp_target_memcpy# family of routines
...
References in the construct to a list item that appears in a
\verb#get_device_ptr# clause are \verb#private# and become device pointers to
the corresponding list item in the device data environment.
...
\begin{itemize}
  ...
  \item A list item in a \code{get\_device\_ptr} clause must have a
    corresponding list item in the device data environment.
  \item References in the construct to a list item that appears in a
    \code{get\_device\_ptr} clause must be to the address of the list item.
\end{itemize}
...
The \verb#device_ptr# clause is used to indicate that a list item is a device
pointer.  All references in the construct to a list item that appears in a
\code{device\_ptr} clause refer to the list item.
...
\item A \plc{map-type} in a \code{map} clause must be \code{to}, \code{from}, \code{tofrom} or \code{alloc}.
  \item The list-items that appear in a \verb#device_ptr# must be valid
...
\cppspecificstart
\item A list item that appears in a \code{device\_ptr} clause must have a type
...
\cppspecificend
\fortranspecificstart
\item A list item that appears in a \code{device\_ptr} clause must be a dummy
  argument.
\fortranspecificend
