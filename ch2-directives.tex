...
that causes a new explicit task to be created. The event occurs after the task is initialized but before 
it begins execution or is deferred. If a task is merged, no \plc{task-create} event should occur.
