...
If the \code{uval} modifier is specified for a list item, then it is assumed that the address of the original list item has an invariant value for all the iterations of the associated loop(s).
