...
binds to the innermost enclosing region of the type corresponding to the \plc{type-clause} 
...
\binding
The binding thread set of the \code{cancellation point} region is the current task region and to the innermost enclosing region of the type corresponding to the \plc{type-clause} 
specified in the directive (that is, the innermost \code{parallel}, \code{sections}, loop, or 
\code{taskgroup} region).
