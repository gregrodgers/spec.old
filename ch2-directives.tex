...
\index{clauses!collapse@{\code{collapse}}}
The \code{collapse} clause or the \code{ordered} clause with the parameter 
may be used to specify how many loops are associated with the loop construct. 
The number of loops associated is determined by the parameters of the 
\code{collapse} clause and the \code{ordered} clause, which must be 
constant positive integer expressions.
