...
\item Clauses that may be specified on directives to control the data-mapping of variables to a device data enfironment are described in \specref{subsec:map Clause}.
\end{itemize}
...
\item If a  variable is not a scalar then it is treated if it had appeared 
