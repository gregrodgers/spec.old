...
original list item. 
When a \code{lastprivate} clause appears on a \code{target} directive, the
value of the new list item is assigned to the original list item at the end of
the \code{target} region.
