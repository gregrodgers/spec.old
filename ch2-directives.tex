...
Conditional execution of the target and/or conditional multi-threading of the \code{parallel} construct  can
be specified with the modified \code{if} clause for combined and composite constructs by using
the \plc{target:} and \plc{parallel:} \plc{directive-name} modifiers.
See \specref{subsec:Combined and Composite Construct Clauses}.
\ccppspecificend
...
Conditional execution of the target and/or conditional multi-threading of the \code{parallel} constuct can
be specified with the modified \code{if} clause for combined and composite constructs by using
the \plc{target:} and \plc{parallel:} \plc{directive-name} modifiers.
See \specref{subsec:Combined and Composite Construct Clauses}.
\fortranspecificend
...
Conditional execution of the target and/or conditional multi-threading of the parallel loop can
be specified with the modified \code{if} clause for combined and composite constructs by using
the \plc{target:} and \plc{parallel:} \plc{directive-name} modifiers.
See \specref{subsec:Combined and Composite Construct Clauses}.
\ccppspecificend
