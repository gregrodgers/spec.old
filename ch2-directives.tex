...
A thread invokes a registered \code{ompt\_callback\_parallel\_end}
callback for each occurrence of a \plc{parallel-end} event in that
thread.  The callback occurs in the task encountering
the parallel construct.  This callback has the type signature
\code{ompt\_callback\_parallel\_end\_t}.

A thread invokes a registered \code{ompt\_callback\_idle}
...
A thread invokes a registered \code{ompt\_callback\_thread\_begin}
...
\code{ompt\_callback\_thread_begin\_t}. 

A thread invokes a registered \code{ompt\_callback\_thread\_end}
...
\code{ompt\_callback\_thread_end\_t}. 
