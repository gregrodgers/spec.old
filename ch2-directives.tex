...
but before the first OpenMP \emph{region} begins to execute.

The \plc{initial-thread-end} event occurs as the final event in an \emph{initial thread} at the end of an \emph{initial task} 
