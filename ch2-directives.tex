...
A thread invokes a registered \code{ompt\_callback\_device\_initialize}
...
\tools
Callbacks associated with a \plc{target task} are the same as for the \code{task} construct defined in \specref{subsec:task Construct}.
