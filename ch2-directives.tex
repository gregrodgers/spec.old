...
List items that appears in a \verb#get_device_ptr# clause are \verb#private#
and assigned to device pointers to the corresponding list item in the device data
environment for the duration of the construct.
...
outside of \verb#omp_target_alloc()# and the \verb#get_device_ptr()# clause,
is implementation defined.
