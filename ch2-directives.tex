...
where \plc{dependence-type} is \code{source} or \code{sink}.
...
The current iteration is blocked until all specified source iterations
encounter an \code{ordered} construct with the \code{source} \plc{dependence-type}.
