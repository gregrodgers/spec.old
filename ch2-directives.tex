...
For any \code{in\_reduction} clause present at the \code{taskloop} construct, an \code{in\_reduction} clause with the same reduction operator and the same list items of the \code{in\_reduction} clause is applied to the generated tasks.
...
For the \code{taskloop} construct, private copies are created in accordance to the rules of the \code{task\_reduction} and \code{in\_reduction} clauses. 
