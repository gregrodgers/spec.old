...
The following ICV stores a value that affects the operation of the tool interface.
...
\toolsToDo{No tools paragraph needed for \code{declare}~\code{target}?}
...
\tools
\toolsToDo{\code{cancelation}~\code{point}}
