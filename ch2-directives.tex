...
computed. Reduction participating clauses define the constructs that
...
region that participates in a reduction defined by a reduction scoping clause.
...
In any case, the final value of the reduction must be determined as if all
regions that participate in the reduction are executed sequentially in some
arbitrary order.
