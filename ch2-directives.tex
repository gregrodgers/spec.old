...
implicit \code{task} and has type signature \code{ompt\_scoped\_implicit\_callback\_t}.
...
\item \code{ompt\_scoped\_implicit\_callback\_t} type signature of the implicit
task begin and end callbacks, see 
\specref{sec:ompt_scoped_implicit_callback_t}.
...
\item \code{ompt\_scoped\_work\_callback\_t} type signature of the sections
begin and end callback, see 
\specref{sec:ompt_scoped_worksharing_callback_t}.
\end{itemize}
...
\crossreferences
\begin{itemize}
\item \code{ompt\_scoped\_work\_callback\_t} type signature of the workshare
begin and end callback, see 
\specref{sec:ompt_scoped_worksharing_callback_t}.
\end{itemize}
...
\item \code{ompt\_scoped\_target\_callback\_t} type signature of the target
begin and end callback, see 
\specref{sec:ompt_scoped_target_callback_t}.
...
\item \code{ompt\_scoped\_work\_callback\_t} type signature of the distribute
begin and end callback, see 
\specref{sec:ompt_scoped_worksharing_callback_t}.
\end{itemize}
...
\crossreferences
\begin{itemize}
\item \code{ompt\_scoped\_master\_callback\_t} type signature of the master
begin and end callback, see 
\specref{sec:ompt_scoped_master_callback_t}.
\end{itemize}
...
\crossreferences
\begin{itemize}
\item \code{ompt\_scoped\_sync\_region\_callback\_t} type signature of the barrier
begin and end callback, see 
\specref{sec:ompt_scoped_sync_region_callback_t}.
\end{itemize}
...
\item \code{ompt\_scoped\_sync\_region\_callback\_t} type signature of the taskwait
begin and end callback, see 
\specref{sec:ompt_scoped_sync_region_callback_t}.
\end{itemize}
...
\item \code{ompt\_scoped\_sync\_region\_callback\_t} type signature of the taskgroup
begin and end callback, see 
\specref{sec:ompt_scoped_sync_region_callback_t}.
\end{itemize}
