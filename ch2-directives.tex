...
\plc{dependence-type}, it waits until its dependendences on 
...
Its dependence on a valid iteration is satisfied when the iteration 
completes execution or when a thread executing that iteration encounters 
an \code{ordered} construct with a \code{depend} clause with the 
\code{source} \plc{dependence-type}. 
