...
\begin{itemize}
\item If the thread is at a \code{cancel} or \code{cancellation point} region, the encountering task checks for active cancellation of the innermost enclosing region of the type specified.  
...
\item If the encountering task is at a \code{barrier} region, the encountering task checks for active cancellation of the innermost enclosing parallel region. If cancellation has been activated, then the encountering task continues execution at the end of the canceled region.

\item If the encountering task is at an implicit barrier region, the encountering task checks for active cancellation of the innermost parallel region that encloses the parallel region to which the implicit barrier belongs. If cancellation has been activated, then the encountering task continues execution at the end of the canceled region.
\end{itemize}
