...
A \code{reduction} clause that is present at the \code{taskloop} construct behaves as if a \code{task\_reduction} clause was applied to the implicit \code{taskgroup} construct enclosing the \code{taskloop} construct.
