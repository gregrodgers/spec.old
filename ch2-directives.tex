...
generating task, which is a target task. The \code{target}
region binds to the target task region.
...
generating task, which is a target task. The \code{target}~\code{update}
region binds to the target task region.
...
the generating task, which is a target task. The
\code{target}~\code{enter}~\code{data} region binds to the target task region.
...
\fortranspecificend
\binding
The binding task for a \code{target}~\code{exit}~\code{data} region is the
generating task, which is a target task. The
\code{target}~\code{exit}~\code{data} region binds to the target task region.
