...
The cancellation point impled at a \code{cancel} construct point only checks if cancellation of the type specified in the clause has been requested.
Implict barriers and \code{barrier} regions only check for cancellation of the innermost enclosing construct.
