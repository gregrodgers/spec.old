...
All clauses are evaluated when the \code{target enter data} construct is encountered.  The data environment of the \plc{target task} is created according to the data-sharing attribute clauses on the \code{target enter data} construct, per-data environment ICVs, and any default data-sharing attribute rules that apply to the \code{target enter data} construct.  A variable that is mapped in the target construct has a default data-sharing attribute of shared in the data environment of the \plc{target task}.
...
All clauses are evaluated when the \code{target exit data} construct is encountered.  The data environment of the \plc{target task} is created according to the data-sharing attribute clauses on the \code{target exit data} construct, per-data environment ICVs, and any default data-sharing attribute rules that apply to the \code{target exit data} construct.  A variable that is mapped in the target construct has a default data-sharing attribute of shared in the data environment of the \plc{target task}.
...
The \code{target update} construct is a task generating construct.  The generated task is a \plc{target task}.  The generated task region encloses the \code{target update} region.

All clauses are evaluated when the \code{target update} construct is encountered.  The data environment of the \plc{target task} is created according to the data-sharing attribute clauses on the \code{target update} construct, per-data environment ICVs, and any default data-sharing attribute rules that apply to the \code{target update} construct.  A variable that is mapped in the target construct has a default data-sharing attribute of shared in the data environment of the \plc{target task}.
