...
The schedule \plc{modifier} can be one of those specified in Table~\ref{tab:Schedule Clause Modifier Values}. If neither the \code{monotonic} modifier nor the \code{nonmonotonic} modifier are specified it will be as if the \code{monotonic} modifier was specified for the \code{static} schedule kind or if the \code{ordered} clauses is specified. It will be as if the \code{nonmonotonic} modifier was specified otherwise.
