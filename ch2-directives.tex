...
For each task that is generated by the \code{taskloop} construct a \code{in\_reduction} clause with the same reduction operator and the same list items of the \code{task\_reduction} clause is applied to the task.
