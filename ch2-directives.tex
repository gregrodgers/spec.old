...
task regions or SIMD lanes. All properties common to all reduction clauses,
...
participant region in a reduction defined by a reduction scoping clause. All
...
In any case, the final value of the reduction must be as if all participant
regions were executed sequentially in some arbritary order.
