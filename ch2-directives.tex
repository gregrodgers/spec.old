...
\item If variables that share storage are mapped, the behavior is unspecified, with the exceptions of a structure sharing storage with its structure elements.
