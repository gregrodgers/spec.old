...
\item \code{ompt\_parallel\_begin\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_parallel_begin_callback_t}.

\item \code{ompt\_scoped\_implicit\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_scoped_implicit_callback_t}.

\item \code{ompt\_parallel\_end\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_parallel_end_callback_t}.
...
\item \code{ompt\_scoped\_worksharing\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_scoped_worksharing_callback_t}.
...
\item \code{if} Clause, see \specref{sec:if Clause}.
\item \code{ompt\_task\_create\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_task_create_callback_t}.
\item \code{ompt\_task\_schedule\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_task_schedule_callback_t}.
\end{itemize}
...
On entry to the \code{target}~\code{data} region, the executing thread
shall invoke the callback \code{ompt\_event\_target\_data}, if registered, with
\code{endpoint=ompt\_scope\_begin}.
This callback has type signature \code{ompt\_scoped\_target\_data\_callback\_t}.

On exit from the \code{target}~\code{data} region, the executing thread
may invoke the callback \code{ompt\_event\_target\_data}, if registered, with
...
\item ToDo: \code{ompt\_scoped\_target\_data\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_scoped_worksharing_callback_t}.
...
\item \code{ompt\_scoped\_target\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_scoped_target_callback_t}.
...
\crossreferences
\begin{itemize}
\item \code{ompt\_scoped\_master\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_scoped_master_callback_t}.
\end{itemize}
...
\item \code{ompt\_mutex\_acquire\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_mutex_acquire_callback_t}.

\item \code{ompt\_mutex\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_mutex_callback_t}.
\end{itemize}
...
\crossreferences
\begin{itemize}
\item \code{ompt\_scoped\_sync\_region\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_scoped_sync_region_callback_t}.
\end{itemize}
...
\crossreferences
\begin{itemize}
\item \code{ompt\_flush\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_flush_callback_t}.
\end{itemize}
...
\item \code{ompt\_task\_dependences\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_task_dependences_callback_t}.

\item \code{ompt\_task\_dependence\_callback\_t} type signature of the event, see 
\specref{subsec:ompt_task_dependence_callback_t}.
\end{itemize}
