...
\begin{itemize}
\item The loop region to which an \code{ordered} region without any clause or with a \code{threads} clause clause binds must have an \code{ordered} clause without the parameter specified on the corresponding loop directive. 
