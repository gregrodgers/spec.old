...
As there is no implicit barrier at the end of the construct, to avoid data races the original
list items modified due to \code{lastprivate} or \code{linear} clauses
should not be accessed in between the end of the \code{distribute} construct and the end
of the \code{teams} region in which the \code{distribute} region has been nested.
