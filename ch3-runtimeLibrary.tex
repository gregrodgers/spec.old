...
\fortranspecificstart
\begin{boxedcode}
int function omp\_tool\_control(\plc{command}, \plc{modifier})
integer \plc{command}
...
\ccppspecificstart
\begin{boxedcode}
#define OMP_TOOL_CONTROL_NOTOOL     (-2)
#define OMP_TOOL_CONTROL_NOCALLBACK (-1)
#define OMP_TOOL_CONTROL_SUCCESS      0
#define OMP_TOOL_CONTROL_IGNORED      1
\end{boxedcode}
\ccppspecificend
}
...
\fortranspecificstart
\begin{boxedcode}
integer, parameter :: OMP\_TOOL\_CONTROL\_NOTOOL =     -2 
integer, parameter :: OMP\_TOOL\_CONTROL\_NOCALLBACK = -1
integer, parameter :: OMP\_TOOL\_CONTROL\_SUCCESS =     0
integer, parameter :: OMP\_TOOL\_CONTROL\_IGNORED =     1
\end{boxedcode}
\fortranspecificend
}
