...
\item \code{ompt\_callback\_tcontrol}, see \specref{sec:ompt_callback_tcontrol}
\item \code{ompt\_tcontrol\_callback\_t}, see \specref{sec:ompt_callback_tcontrol_t}
\end{itemize}
