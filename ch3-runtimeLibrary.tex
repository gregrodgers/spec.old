...
The routine returns zero if successful. If both \verb#dst# and \verb#src# 
are \code{NULL} pointers, the routine returns the number of dimensions 
supported by the implementation for the specified device numbers.
Otherwise, it returns a non-zero value. The routine contains a task
scheduling point.
