...
\fortranspecificstart
\begin{boxedcode}
integer, parameter :: omp\_control\_tool\_start = 1
integer, parameter :: omp\_control\_tool\_pause = 2
integer, parameter :: omp\_control\_tool\_flush = 3
integer, parameter :: omp\_control\_tool\_end = 4
\end{boxedcode}
\fortranspecificend
}
...
\item \code{ompt\_callback\_control\_tool\_t}, see \specref{sec:ompt_callback_control_tool_t}
\end{itemize}
