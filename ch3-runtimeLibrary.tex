...
\begin{itemize}
  ...
  \item The device specified by \vcode|device_num| must be valid
\end{itemize}
...
The \vcode|omp_target_memcpy_rect| routine copies a rectangular subvolume from
...
The \vcode|omp_target_memcpy_rect| routine contains a tasks scheduling point.
