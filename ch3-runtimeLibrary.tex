...
\noindent
%
A command of \code{omp\_tcontrol\_start} asks a tool to start or 
...
%
A command of \code{omp\_tcontrol\_pause} asks a tool to temporarily 
turn monitoring off. If monitoring is already off, it is idempotent.
%
A command of \code{omp\_tcontrol\_flush} asks a tool to flush any data that 
it has buffered. This command may be applied whether monitoring is on or off.
%
A command of \code{omp\_tcontrol\_end} turns monitoring off permanently;  
