...
\code{ompt\_tcontrol\_callback} callback for each occurrence of a
...
signature \code{ompt\_tcontrol\_callback\_t}.The callback may return
...
\item \code{ompt\_tcontrol\_callback\_t}, see \specref{sec:ompt_tcontrol_callback_t}
\end{itemize}
