...
specified by the first argument \code{kind}. It can be any of the standard schedule types or 
...
first argument \code{kind} returns the schedule to be used. It can be any of the standard 
...
\effect
The \code{omp\_get\_thread\_limit} routine returns the maximum number of OpenMP 
threads available on the device as stored in the ICV \plc{thread-limit-var}.
