...
\item \code{OMP\_MAX\_TASK\_PRIORITY} sets the \plc{max-task-priority-var} that specifies the maximum
...
will inform the implementation that values specified in \code{priority} clauses should
be considered (up to this maximum value) in task scheduling. The default value for this
environment variable is zero.
