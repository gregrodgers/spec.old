...
The \code{OMP\_THREAD\_LIMIT} environment variable sets the number of OpenMP threads 
to use for the whole OpenMP program by setting the \plc{thread-limit-var} ICV. 
