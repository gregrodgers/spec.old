...
\summary
The \code{ompt\_get\_device\_id} routine returns the device
...
\summary
The callback routine with type signature \code{ompt\_target\_get\_time\_t} 
...
\summary
The \code{ompt\_target\_translate\_time} routine translates
...
\summary
A tool uses the function \code{ompt\_target\_set\_trace\_native} to
