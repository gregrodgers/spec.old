...
\code{ompt\_callback\_target\_transfer}       &   &   & * \\
...
typedef enum ompt_callback_t \{
  ...
  ompt_callback_target_transfer          = 9,
...
typedef struct ompt_record_ompt_s \{
  ...
  union \{
    ...
    ompt_target_transfer_record_t \plc{target_transfer};
...
\omptcallbacksignature{\code{ompt\_callback\_target\_transfer\_t}}
\index{ompt\_callback\_target\_transfer\_t@{\code{ompt\_callback\_target\_transfer\_t}}}
\label{sec:ompt_callback_target_transfer_t}
\format

\vbox{
\ccppspecificstart
\begin{boxedcode}
typedef void (*ompt_callback_target_transfer_t) (
  ompt_id_t \plc{target_id},
