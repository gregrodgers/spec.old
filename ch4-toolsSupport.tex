...
The argument \verb|next_state| is a pointer to an \verb|int| that will be set to the code for the next state in the enumeration.
The argument \verb|next_state_name| is the address of a character pointer
