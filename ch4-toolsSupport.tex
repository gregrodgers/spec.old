...
\descr
\argdesc
The \callbackarg{} \plc{endpoint} that indicates whether the callback signals
the begin or end of the scope and a \callbackarg{} \plc{thread\_num} that indicates
...
The \callbackarg{} \plc{endpoint} indicates whether the callback indicates whether the
