...
\item \code{ompt\_device\_initialize\_callback\_t}, see \specref{sec:ompt_device_initialize_callback_t}.
\end{itemize}
...
\code{ompt\_callback\_target\_data\_map}      & * & * & * \\
...
\item \code{ompt\_event\_thread\_end}, see \specref{sec:ompt_callback_thread_end}. 
...
\end{comment}
\item \code{ompt\_event\_runtime\_shutdown}, see \specref{sec:ompt_callback_runtime_shutdown}.
\item \code{ompt\_event\_idle}, see \specref{sec:ompt_callback_idle}. 
\item \code{ompt\_event\_sync\_region\_wait}, see \specref{sec:ompt_callback_runtime_shutdown}.
\item {\em incomplete cross references stubbed out} 
\begin{comment}
...
typedef enum ompt_callback_t \{
  ...
  ompt_callback_runtime_shutdown         = 12,
  ompt_callback_idle                     = 13,
  ompt_callback_sync_region_wait         = 14,
  ompt_callback_mutex_release            = 15,
  ompt_callback_task_dependences         = 16,
  ompt_callback_task_dependence_pair     = 17,
  ompt_callback_work                     = 18,
  ompt_callback_master                   = 19,
  ompt_callback_target_data_map          = 20,
  ompt_callback_sync_region              = 21,
  ompt_callback_init_lock                = 22,
  ompt_callback_destroy_lock             = 23,
  ompt_callback_mutex_acquire            = 24,
  ompt_callback_mutex_acquired           = 25,
  ompt_callback_nested_lock              = 26,
  ompt_callback_flush                    = 27,
  ompt_callback_device_initialize        = 28
  ompt_callback_cancel                   = 29
\} ompt_callback_t;
\end{boxedcode}
\ccppspecificend
}
...
\item \code{ompt\_callback\_thread\_begin\_callback\_t} callback type, see \specref{sec:ompt_thread_begin_callback_t}.
\item \code{ompt\_callback\_thread\_begin\_t} callback type, see \specref{sec:ompt_thread_begin_callback_t}.
\item \code{ompt\_callback\_parallel\_end\_t} callback type, see
  \specref{sec:ompt_callback_parallel_end_t}.
\item \code{ompt\_callback\_parallel\_end\_t} callback type, see \specref{sec:ompt_parallel_end_callback_t}.
...
\item \code{ompt\_callback\_task\_master\_callback\_t} callback type,
...
\crossreferences
\begin{itemize}
\item \code{ompt\_callback\_idle\_t} callback type, see \specref{sec:ompt_idle_callback_t}.
\item \code{ompt\_callback\_implicit\_task\_t} callback type, see
...
\index{ompt\_callback\_thread\_end\_callback\_t@{\code{ompt\_thread\_end\_callback\_t}}}
...
\ccppspecificstart
\begin{boxedcode}
typedef void (*ompt_callback_parallel_end_callback_t) (
               ompt_data_t *\plc{parallel_data},
...
\index{ompt\_implicit\_callback\_t@{\code{ompt\_callback\_implicit\_task\_t}}}
...
\crossreferences
\begin{itemize}
\item \code{ompt\_event\_t} enumeration type, see \specref{sec:ompt_callback_t}.
