...
\subsection{Dummy Type Signature for Callbacks}
...
typedef struct ompt_record_native_abstract_s \{
  ...
  const char *\plc{type};
  ompt_target_time_t \plc{start\_time};
  ompt_target_time_t \plc{end\_time};
  uint64_t \plc{hwid};
...
typedef struct ompt_record_thread_begin_s \{
  ompt_thread_type_t \plc{thread_type};    /* type of thread */
...
typedef struct ompt_record_idle_s \{
  ompt_scope_endpoint_t \plc{endpoint};    /* begin or end */
\} ompt_record_idle_t;
\end{boxedcode}
\ccppspecificend
}
...
typedef struct ompt_record_parallel_begin_s \{
  ompt_id_t \plc{parent_task_id};          /* ID of parent task           */
  const ompt_frame_t *\plc{parent_frame};  /* frame data of parent task   */
  ompt_id_t \plc{parallel_id};             /* ID of parallel region       */
  uint32_t \plc{requested_team_size};      /* requested number of threads */
  ompt_invoker_t \plc{invoker};            /* who invokes master task?    */
  const void *\plc{codeptr_ra};            /* return address of api call  */
...
typedef struct ompt_record_parallel_end_s \{
  ompt_id_t \plc{parallel_id};             /* ID of parallel region       */
  ompt_id_t \plc{task_id};                 /* ID of task                  */
  ompt_invoker_t \plc{invoker};            /* who invokes master task?    */
  const void *\plc{codeptr_ra};            /* return address of api call  */ 
...
typedef struct ompt_record_task_create_s \{
  ompt_id_t \plc{parent_task_id};          /* ID of parent task           */
  const ompt_frame_t *\plc{parent_frame};  /* frame data for parent task  */
  ompt_id_t \plc{new_task_id};             /* ID of created task          */
  ompt_task_type_t \plc{type};             /* type of task being created  */ 
  int \plc{has_dependences};               /* task has data dependences   */
  const void *\plc{codeptr_ra};            /* return address of api call  */ 
...
typedef struct ompt_record_task_dependence_s \{
  ompt_id_t \plc{src_task_id};             /* ID of dependence source     */
  ompt_id_t \plc{sink_task_id};            /* ID of dependence sink       */
...
typedef struct ompt_record_task_schedule_s \{
  ompt_id_t \plc{prior_task_id};           /* ID of descheduled task      */
  int \plc{prior_completed};               /* true if prior task completed*/
  ompt_id_t \plc{next_task_id};            /* ID of scheduled task        */
...
typedef struct ompt_record_scoped_implicit_s \{
  ...
  ompt_id_t \plc{parallel_id};             /* ID of parallel region       */
  ompt_id_t \plc{task_id};                 /* ID of task                  */
  uint32_t \plc{thread_num};               /* OMP thread num              */
...
typedef struct ompt_record_scoped_sync_region_s \{
  ompt_sync_region_kind_t \plc{kind};      /* barrier, taskwait, taskgroup*/
  ompt_scope_endpoint_t \plc{endpoint};    /* begin or end                */ 
  ompt_id_t \plc{parallel_id};             /* ID of parallel region       */
  ompt_id_t  \plc{task_id};                /* ID of task                  */
  const void *\plc{codeptr_ra};            /* return address of api call  */
...
typedef struct ompt_record_lock_init_s \{
  int \plc{is_nest_lock};                  /* nested lock or not          */
...
typedef struct ompt_record_lock_destroy_s \{
  int \plc{is_nest_lock};                  /* nested lock or not          */
  ompt_wait_id_t \plc{wait_id};            /* ID of mutex being awaited   */
  const void *\plc{codeptr_ra};            /* return address of api call  */       
...
typedef struct ompt_record_mutex_acquire_s \{
  ompt_mutex_kind_t \plc{kind};            /* kind of mutex               */
  uint32_t \plc{hint};                     /* based on OMP lock hint      */
  uint32_t \plc{impl};                     /* implementation of mutex     */
  ompt_wait_id_t \plc{wait_id};            /* ID of mutex being awaited   */
  const void *\plc{codeptr_ra};            /* return address of api call  */          
...
typedef struct ompt_record_mutex_s \{
  ompt_mutex_kind_t \plc{kind};             /* type of mutex               */
  ompt_wait_id_t \plc{wait_id};             /* ID of mutex being awaited   */
  const void *\plc{codeptr_ra};             /* return address of api call  */       
\} ompt_record_mutex_t;
\end{boxedcode}
...
typedef struct ompt_record_target_data_s \{
  ompt_id_t \plc{host_op_id};              /* host side ID for operation  */
  ompt_target_data_op_t \plc{optype};      /* type of operation           */
  void *\plc{host_addr};                   /* host address of the data    */
  void *\plc{device_addr};                 /* device address of the data  */ 
  size_t \plc{bytes};                      /* number of bytes mapped      */
  ompt_target_time_t \plc{end_time};       /* end time                    */
...
typedef struct ompt_record_target_kernel_s \{
  ompt_id_t \plc{host_op_id};              /* host side ID for operation  */
  uint32_t \plc{granted_num_teams};        /* number of teams granted     */
  ompt_target_time_t \plc{end_time};       /* end time                    */
...
typedef struct ompt_record_scoped_worksharing_s \{
  ompt_worksharing_type_t \plc{wstype};    /* loop, sections, single ...  */
  ompt_scope_endpoint_t \plc{endpoint};    /* begin or end                */
  ompt_id_t \plc{parallel_id};             /* ID of parallel region       */
  ompt_id_t \plc{task_id};                 /* ID of task                  */
  const void *\plc{codeptr_ra};            /* return address of api call  */
...
typedef struct ompt_record_flush_s \{
  void *\plc{codeptr_ra};                  /* return address of api call  */
\} ompt_record_flush_t;
\end{boxedcode}
\ccppspecificend
}
...
\subsubsection{\code{ompt\_cancel\_flag\_t}}
...
typedef void (*ompt_parallel_begin_callback_t) (
               ...
               const ompt_frame\_t * \plc{parent_frame},
...
\subsubsection{\code{ompt\_cancell\_callback\_t}}
...
typedef int (*ompt_enumerate_mutex_kinds_t)(
  int \plc{current_kind}, 
  int *\plc{next_kind}, 
  const char **\plc{next_kind_name}
);
\end{boxedcode}
\ccppspecificend
}
...
should pass \code{ompt\_mutex\_kind\_unknown} as the first
...
\code{ompt\_enumerate\_mutex\_kinds\_fn}.
...
an OpenMP implementation's \code{ompt\_set\_callback} 
entry point.

A tool uses set callback entry point to install a 
pointer to a tool callback that an OpenMP implementation 
will invoke when an OpenMP event occurs on the current device.

The return value of set callback may indicate several possible
...
\code{ompt\_data\_t}. The \code{ompt\_get\_thread\_data} entry point
returns a pointer to the thread data object, if any, associated with the
current thread. If the current thread is unknown to the OpenMP
runtime, the entry point returns \code{NULL}.

A tool may use a pointer to an OpenMP thread's data object that it
obtains from this entry point to 
...
The \code{ompt\_get\_state} entry point with type signature
\code{ompt\_get\_state\_t} is used to retrieve the state and the wait
...
to the specified data type or \code{NULL}.
...
regions. An OpenMP implementation's \code{ompt\_get\_parallel\_info} entry point
with type signature \code{ompt\_get\_parallel\_info\_t} 
can be used to obtain information about the current parallel region,
if any, and any enclosing parallel regions. 

The first argument to the entry point specifies the ancestor level of the parallel region
of interest to a tool.
...
If an enclosing parallel region exists at the specified ancestor
level, a reference to the parallel region's associated data object will be
assigned to the pointer passed by reference as the second
argument to the entry point and the number of threads in the team associated with the 
parallel region will be assigned to the variable passed as the third
argument to the entry point.

If no enclosing parallel region exists at the specified ancestor
level, the values of the variables provided by reference as the second
and third arguments to the entry point are undefined following the
call.
...
\subsection{Entry Points in the OMPT Tracing Interface}
...
(\code{ompt\_record\_native\_info}) or represents an event
(\code{ompt\_record\_native\_event}). Knowing whether a record
...
\subsection{Lookup Entry Point Signature}
