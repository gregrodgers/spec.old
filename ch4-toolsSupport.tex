...
\code{ompt\_initialize\_fn\_t} to the OpenMP implementation,
immediately after the OpenMP implementation is fully initialized, the
OpenMP implementation will invoke the tool initializer.
...
Most events trigger during the execution of OpenMP directives. One
event triggers when an application calls the \code{omp\_tcontrol}. 
