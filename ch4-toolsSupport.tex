...
\item \code{ompt\_callback\_task\_dependencies\_t} callback type, see \specref{sec:ompt_callback_task_dependencies_t}.
...
\ccppspecificstart
\begin{boxedcode}
typedef void (*\plc{ompt_callback_master_t}) (
               ompt_scope_endpoint_t \plc{endpoint},
               ompt_data_t *\plc{parallel_data},
               ompt_data_t *\plc{task_data},
               const void *\plc{codeptr_ra}
...
\omptcallbacksignature{\code{ompt\_callback\_target\_data\_map\_t}}
\index{ompt\_callback\_target\_data\_map\_t@{\code{ompt\_callback\_target\_data\_map\_t}}}
\label{sec:ompt_callback_target_data_map_t}
\format
\vbox{
\ccppspecificstart
\begin{boxedcode}
typedef void (*ompt_callback_target_data_map_t) (
  ompt_id_t \plc{target_id},
...
\descr
The callbacks with type signature \code{ompt\_callback\_target\_data\_map\_t},
include a parameter \plc{requested\_team\_size}
that indicates the number of threads requested by the user, and a parameter
\plc{actual\_team\_size} that indicates the number of threads in the team.
The \plc{invoker} argument explains whether the execution of the parallel
...
\descr
The callbacks with type signature \code{ompt\_callback\_target\_submit\_t},
include a parameter \plc{requested\_team\_size}
that indicates the number of threads requested by the user, and a parameter
\plc{actual\_team\_size} that indicates the number of threads in the team.
The \plc{invoker} argument explains whether the execution of the parallel
