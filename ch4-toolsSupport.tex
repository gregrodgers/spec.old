...
\item \code{ompt\_callback\_parallel\_end}, see \specref
...
\end{comment}
\item \code{ompt\_callback\_runtime\_shutdown}, see \specref{sec:ompt_callback_runtime_shutdown}.
...
\item \code{ompt\_callback\_task\_dependence\_pair}, see \specref
