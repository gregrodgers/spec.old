...
Valid values for \code{enable} are 0 and 1.  A value of 1 for
\code{enable} indicates that recording of events of type \code{rtype}
...
should be enabled or disabled for a specific event type.
