...
Section~\ref{sec:ompt_target_set_trace_ompt_t}  describes how to enable or disable
tracing on a target device for specific OMPT events.
Section~\ref{sec:ompt_target_set_trace_native_t}  describes how to enable or
disable tracing on a target device for specific native events.
The Sections~\ref{sec:ompt_target_start_trace_t}, \ref{sec:ompt_target_pause_trace_t} 
and \ref{sec:ompt_target_stop_trace_t}  describe how to start, pause and
...
\summary
The runtime tool entry point with type signature \code{ompt\_function\_lookup\_t}
...
\summary
The runtime tool entry point known as \code{ompt\_enumerate\_states} 
...
The runtime tool entry point known as \code{ompt\_enumerate\_mutex\_kinds} 
...
The runtime tool entry point known as \code{ompt\_set\_callback} 
...
event. For an event with enumeration value name {\ttfamily\bfseries ompt\_event\_{\em xxx}}, 
...
The runtime tool entry point known as \code{ompt\_get\_callback} 
...
\summary
The runtime tool entry point known as \code{ompt\_get\_thread\_data}
...
\summary
The runtime tool entry point known as \code{ompt\_get\_state}
...
\summary
The runtime tool entry point known as \code{ompt\_get\_parallel\_info} 
...
\summary
The runtime tool entry point known as \code{ompt\_get\_task\_info} 
...
\summary
The runtime tool entry point known as \code{ompt\_get\_target\_info} 
...
\summary
The runtime tool entry point known as \code{ompt\_get\_num\_devices} 
...
\summary
The runtime tool entry point known as \code{ompt\_get\_device\_info} 
...
\summary
The runtime tool entry point known as \code{ompt\_get\_device\_id} 
...
\summary
The runtime tool entry point known as \code{ompt\_target\_get\_time} 
with type signature \code{ompt\_target\_get\_time\_t} 
returns the current time on a specified target device.
...
\summary
The runtime tool entry point known as \code{ompt\_target\_translate\_time} 
with type signature \code{ompt\_target\_translate\_time\_t} translates
...
\summary
The runtime tool entry point known as \code{ompt\_target\_set\_trace\_ompt} 
with type signature \code{ompt\_target\_set\_trace\_ompt\_t} 
...
codes for \code{ompt\_target\_set\_trace\_ompt}.  If a single invocation
of \code{ompt\_target\_set\_trace\_ompt} is used to enable or disable
...
\end{tabular}
\caption{Meaning of return codes for {\ttfamily ompt\_trace\_set\_ompt} and {\ttfamily ompt\_target\_set\_trace\_native}.}
...
\summary
The runtime tool entry point known as \code{ompt\_target\_set\_trace\_native} 
with type signature \code{ompt\_target\_set\_trace\_native\_t} 
...
\constraints
The argument \code{device} is a handle to idenitfy the target device
whose performance monitoring may be altered by invoking this function.
...
\code{ompt\_target\_set\_trace\_native}.  If a single invocation of
\code{ompt\_target\_set\_trace\_ompt} is used to enable/disable more
...
a tool calls the functions \code{ompt\_target\_start\_trace}, \code{ompt\_target\_pause\_trace}, or \code{ompt\_target\_stop\_trace}.
...
\summary
The runtime tool entry point known as \code{ompt\_target\_start\_trace} 
with type signature \code{ompt\_target\_start\_trace\_t} 
starts tracing of activity on a specific target device.
...
\summary
The runtime tool entry point known as \code{ompt\_target\_pause\_trace} 
with type signature \code{ompt\_target\_pause\_trace\_t} 
pauses or restarts activity tracing on a specific target device.
...
\summary
The runtime tool entry point known as \code{ompt\_target\_stop\_trace} 
with type signature \code{ompt\_target\_stop\_trace\_t} 
stops tracing for a target device.
...
\summary
The runtime tool entry point known as \code{ompt\_target\_advance\_buffer\_cursor} 
with type signature \code{ompt\_target\_advance\_buffer\_cursor\_t}
...
\summary
The runtime tool entry point known as
\code{ompt\_target\_buffer\_get\_record\_type} with type signature
\code{ompt\_target\_buffer\_get\_record\_type\_t} inspects the type
of a trace record.
...
\summary
The runtime tool entry point known as \code{ompt\_target\_buffer\_get\_record\_ompt} 
with type signature \code{ompt\_target\_buffer\_get\_record\_ompt\_t} 
...
The runtime tool entry point known as
\code{ompt\_target\_buffer\_get\_record\_native} with type signature
\code{ompt\_target\_buffer\_get\_record\_native\_t} 
...
to \code{ompt\_target\_buffer\_get\_record\_native} may overwrite the
contents of the fields in a record returned by a prior invocation.
...
\summary
The runtime tool entry point known as
\code{ompt\_target\_buffer\_get\_record\_native\_abstract} 
with type signature
\code{ompt\_target\_buffer\_get\_record\_native\_abstract\_t} 
