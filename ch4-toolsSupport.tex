...
typedef struct ompt_record_ompt_s \{
  ...
  union \{
    ...
    ompt_record_scoped_implicit_t \plc{implicit};
    ompt_record_scoped_sync_region_t \plc{sync_region};
    ...
    ompt_record_scoped_nested_lock_t \plc{nested_lock};
    ompt_record_scoped_master_t \plc{master};
    ompt_record_scoped_worksharing_t \plc{worksharing};
