...
\subsection{Initializing the OMPT Callback Interface}
...
\subsection{Initializing the OMPT Tracing Interface}
\index{tool trace initialization tasks}
\label{sec:tool-trace-initialize-tasks}

\subsection{Tracing Device Activity}
...
\begin{itemize}
\item a target device records events that occur during its execution in a trace buffer,
