...
callback has type signature \code{ompt\_callback\_thread_begin\_t}.
...
\code{ompt\_event\_task\_dependence\_pair} & * & * & * & * \\
\code{ompt\_event\_work}                   & * & * & * & * \\
\code{ompt\_event\_master}                 & * & * & * & * \\
\code{ompt\_event\_target\_data\_map}      & * & * & * & * \\
\code{ompt\_event\_sync\_region}           & * & * & * & * \\
\code{ompt\_event\_init\_lock}             & * & * & * & * \\
\code{ompt\_event\_destroy\_lock}          & * & * & * & * \\
\code{ompt\_event\_mutex\_acquire}         & * & * & * & * \\
\code{ompt\_event\_mutex\_acquired}        & * & * & * & * \\
\code{ompt\_event\_nested\_lock}           & * & * & * & * \\
\code{ompt\_event\_flush}                  & * & * & * & * \\
\code{ompt\_event\_device\_initialize}     & * & * & * & * \\
\code{ompt\_event\_cancel}                 & * & * & * & * \\
\bottomrule
\end{tabular}
\vskip 1ex
\caption{Valid return codes of \code{ompt\_set\_callback} for each event.}
...
\item \code{ompt\_event\_thread\_begin}, see \specref{sec:ompt_event_thread_begin}. 
\item \code{ompt\_event\_thread\_end}, see \specref{sec:ompt_event_thread_end}. 
...
\end{comment}
\item \code{ompt\_event\_runtime\_shutdown}, see \specref{sec:ompt_event_runtime_shutdown}.
\item \code{ompt\_event\_idle}, see \specref{sec:ompt_event_idle}. 
\item \code{ompt\_event\_sync\_region\_wait}, see \specref{sec:ompt_event_runtime_shutdown}.
\item {\em incomplete cross references stubbed out} 
\begin{comment}
