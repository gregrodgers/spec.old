...
\ccppspecificstart
\begin{boxedcode}
typedef enum ompt\_record\_native\_kind\_e \{
  ompt\_record\_native\_info  = 1,
  ompt\_record\_native\_event = 2
\} ompt\_record\_native\_kind\_t;
\end{boxedcode}
\ccppspecificend
}
