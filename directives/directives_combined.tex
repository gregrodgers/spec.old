...
\code{parallel} construct containing one \code{master}~\code{taskloop} construct and no other statements.
...
where \plc{clause} can be any of the clauses accepted by the \code{parallel} 
or \code{master}~\code{taskloop} directives, with identical meanings and restrictions.
\end{ccppspecific}
...
where \plc{clause} can be any of the clauses accepted by the \code{parallel} or
\code{master}~\code{taskloop} directives, with identical meanings and restrictions.
\end{fortranspecific}
...
\code{parallel} construct containing one \code{master}~\code{taskloop}~\code{simd} construct and no other statements.
...
where \plc{clause} can be any of the clauses accepted by the \code{parallel} 
or \code{master}~\code{taskloop}~\code{simd} directives, except the \code{in_reduction} clause, with 
identical meanings and restrictions.
\end{ccppspecific}
...
where \plc{clause} can be any of the clauses accepted by the \code{parallel} or
\code{master}~\code{taskloop}~\code{simd} directives, , except the \code{in_reduction} clause, with 
identical meanings and restrictions.
\end{fortranspecific}
