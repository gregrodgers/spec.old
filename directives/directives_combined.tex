...
\item to the \code{loop} construct if it is among the constituent constructs,
...
\item For the \code{order} clause the effect is as if it is applied to all
  constructs for which the \code{order} clause is allowed.
