...
constructs that were combined. Where the constructs to which such
a clause is applied is specified, it will be specified  to apply to one or
both constructs. Otherwise, the constructs to which the clause applies
is unspecified, except that it will apply to at least one of them.
...
for the list item but instead to the other construct being combined.
