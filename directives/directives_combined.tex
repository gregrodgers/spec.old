...
For the \code{private} clause the effect is as if it is applied only to the innermost 
constituent construct.

For the \code{firstprivate} clause the effect is as if it is applied to one or 
