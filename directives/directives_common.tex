...
The base expression of an array section is its named array or named pointer pointer, if
...
\begin{ccppspecific}
\item The base expression of the array section must designate an array or be an lvalue expression of
pointer type.
