...
Suppose \code{a} is declared to be an 1-dimensional array with dimension size
...
Suppose \code{b} is declared to be a pointer to a 2-dimensional array with
...
Suppose \code{c} is declared to be a 3-dimensional array with dimension sizes
