...
extended with the following syntax, and otherwise they contain array
...
\begin{cppspecific}
\item If the type of an array section's base expression is a reference to a type \plc{T} then the type will be considered to be \plc{T} for all purposes of the array section.
