...
\item may be an expression statement, iteration statement, selection statement,
      ...
      by enclosing it in \tcode{\{} and \tcode{\}} would be a 
      \emph{structured block}; and
\end{ccppspecific}
...
\restrictions
Executable directives include a structured block. Restrictions to 
structured blocks are as follows:
