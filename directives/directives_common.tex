...
The \plc{stride} must evaluate to an positive integer.
...
\item \plc{range-specification} is of the form \code{\plc{begin}\code{:}\plc{end[}\code{:}\plc{step]} where \plc{begin} and \plc{end} expressions for which their types can be converted to the \plc{iterator-type} type and \plc{step} is an integral expression.
