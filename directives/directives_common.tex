...
\item A \code{requires} directive with either the \code{unified_address} or
  \code{unified_shared_memory} clause must appear in all \emph{compilation
  units} of a program that contain OpenMP device directives or in none of them.
