...
\item At most one \code{unified_address} clause can appear on the directive.

\item At most one \code{unified_shared_memory} clause can appear on the directive.

\item At most one \code{atomic_default_mem_order} clause can appear on the directive.

\item At most one \code{dynamic_allocators} clause can appear on the directive.

\item At most one \code{reverse_offload} clause can appear on the directive.
