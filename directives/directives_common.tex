...
%% HACK: Moved this paragraph to below table so the table would fit on a page
\vspace{6pt} %% HACK to make spacing after table better...
...
{\small%
\nolinenumbers
\renewcommand{\arraystretch}{1.39}  %% HACK, should be 1.5
\tablefirsthead{%
\hline
