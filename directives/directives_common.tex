...
If the original variable referenced inside a construct is an optional
dummy argument that is not present, any explicitly determined,
implicitly determined, or predetermined data-sharing and data-mapping
attribute rules for that variable are ignored. If the original
variable is an optional dummy argument that is present, the
corresponding variable is present inside the construct.
