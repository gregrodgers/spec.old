...
\begin{ccppspecific}
A \plc{list item} is a variable or array section. An \plc{extended list item} is
...
in the base language. There are some restrictions on the placement of a stand-alone
