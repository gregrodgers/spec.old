...
\item  The default initial value for \plc{max-active-levels-var} is implementation defined, unless \plc{nthreads-var} or \plc{bind-var} is initialized to a list consisting of more than one element via their respective environment variables, in which case the default initial value for \plc{max-active-levels-var} is the maximum supported active levels for the implementation.
\end{itemize}
