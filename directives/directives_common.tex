...
\item \plc{def-allocator-var} - determines the memory allocator to be used by memory allocation routines, directives 
and clauses on the host device when a memory allocator is not specified by the user.

\item \plc{target-def-allocator-var} - determines the memory allocator to be used by memory allocation routines, directives 
and clauses on a target device when a memory allocator is not specified by the user.
