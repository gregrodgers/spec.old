...
\item The value of the \plc{nest-var} ICV is determined by the number of list items in the \plc{nthreads-var} ICV.  If the \plc{nthreads-var} is a list with more than one element, \plc{nest-var} is set to \plc{true}; otherwise it is set to \plc{false}.
