...
\item For functions with a \code{declare simd} directive, the \plc{simd} trait
      is added to the beginning of the set for the generated SIMD versions.
\item For functions with a \code{declare variant} directive, the selectors of
      the \code{construct} selector set are added in the same order to the 
      beginning of the set.
\item For functions within a \code{declare target} block, the \plc{target}
      trait is added to the beginning of the set for the versions of 
