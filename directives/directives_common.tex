...
\begin{ompcPragma}
[[ omp :: \plc{directive-name}( \plc{[clause[}, \plc{clause]... ] }) ]]
\end{ompcPragma}
or
\begin{ompcPragma}
[[ using omp : \plc{directive-name}( \plc{[clause[}, \plc{clause]... ]} ) ]]
\end{ompcPragma}
...
\plc{locator list item} is a \plc{list item}.
...
An OpenMP implementation must support a small set of directives that 
facilitate interactions with the compiler and that support code readability. 
