...
\begin{itemize}
\item
  \plc{third-party-tool-var} - determines whether an OpenMP implementation will collect
...
\plc{third-party-tool-var} & \code{OMP\_DEBUG} & \plc{disabled} \\
...
\item \code{OMP\_DEBUG} environment variable, see \specref{sec:OMP_DEBUG}.
...
\plc{third-party-tool-var} & (none) & (none) \\
