...
If the array section has a named array or named pointer, its base expression
is the named array or named pointer. Otherwise, its base expression is the
left-most expression that does not contain a trailing array section subscript.
