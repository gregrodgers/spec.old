...
The \code{dynamic_allocators} clause makes optional to use the \code{uses_allocator} clause in \code{target} constructs to use allocators in target regions. The \code{dynamic_allocators} clause also allows the usage of the \code{omp_init_allocator} and \code{omp_destroy_allocator} API calls in target regions.
