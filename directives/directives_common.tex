...
{\scode{alignment}} & An integer value which is a power of 2& 1\\
{\scode{access}} & {\scode{all}, \scode{cgroup}, \scode{pteam}, \scode{thread}} & {\scode{all}}\\
{\scode{fallback}} & {\scode{default_fb}, \scode{null_fb}, \scode{abort_fb}, \scode{allocator_fb}} & {\scode{default_fb}}\\
