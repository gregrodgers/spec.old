...
\begin{itemize}
\item \plc{num-procs-var} - the number of processors that are available to the
      device at the time a routine is called to look at this ICV.
      ...
      control of the OpenMP implementation. There is one copy of this ICV per device.
\item \plc{thread-num-var} - the thread number of an implicit task within its binding
      team. There is one copy of this ICV per data environment.
\item \plc{final-task-var} - the task is a final task. There is one copy
      of this ICV per data environment.
\item \plc{implicit-task-var} - the task is an implicit task. There is
      one copy of this ICV per data environment.
\item \plc{team-size-var} - the size of the team. There is one copy of this ICV
...
If an ICV is not listed in this table, there is no OpenMP API routine that
modifies or retrieves this ICV.
