...
\begin{enumerate}
 ...
 \item The \code{kind}, \code{arch} and \code{isa} selectors will have the value $2^{l+1}$, $2^{l+2}$ and $2^{l+3}$ respectively where $l$ is the number of traits in the \plc{construct} set.
