...
\item The value of the \plc{nest-var} ICV is determined to be \plc{true} if \plc{max-active-levels-var} is set to a value greater than 1 (one); otherwise, it is set to \plc{false}.
