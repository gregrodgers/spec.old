...
is performed during compilation. When the \code{at} clause specifies 
\code{runtime}, the error action is performed during program execution when 
a thread encounters the directive. If the \code{at} clause is not specified 
then the \code{error} directive behaves as if the \code{at} clause specifies 
\code{compile}.
