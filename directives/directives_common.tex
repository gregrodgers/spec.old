...
expression, including variables, an array section, or a reserved item locator.
\end{ccppspecific}
...
\plc{locator list item} is a \plc{list item}, or a reserved item locator.
...
Some clauses and directives admit the use of reserved item locators as special
identifiers representing system storage not necessarily bound to any base
language storage item. Reserved item locators may only appear in clauses and
directives where they are explicitly allowed, and may not otherwise be
referenced in the program. The list of reserved item locators is:

\begin{indentedcodelist}
omp_all_memory
\end{indentedcodelist}

Where the \code{omp_all_memory} is a reserved identifier that denotes a list
item treated as having storage that corresponds to the storage of all other
objects in memory
