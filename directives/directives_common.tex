...
\begin{ompSyntax}
\plc{identifier}[(\plc{context-element}[, \plc{context-element}[, ...]])]
...
\begin{ompSyntax}
\plc{trait-set-selector}[,\plc{trait-set-selector}[,...]]

trait-set-selector:
   \plc{trait-set-selector-name}={\plc{trait-selector}[, \plc{trait-selector}[, ...]]}

trait-selector:
   \plc{trait-set-selector-name}[(\plc{trait-property}[, \plc{trait-property}[, ...]])]
\end{ompSyntax}
