...
\begin{cppspecific}
The declaration of the function variant is determined by base language
name lookup in the scope at the start of the base function.  If it is an
overloaded function, the function with appropriate prototype for the
specific OpenMP context and argument types of the base function is selected
