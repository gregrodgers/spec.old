...
\item The initial value of the \plc{max-active-levels-var} is implementation defined, but will be no less than the number of elements for \plc{nthreads-var} or \plc{bind-var} unless their number of elements exceeds the maximum supported active levels of the implementation.
\end{itemize}
