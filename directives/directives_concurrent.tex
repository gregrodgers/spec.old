...
binding thread set is the encountering thread and any other threads from the
binding thread set for that region. If the \code{loop} region does not have a
binding region, then the binding thread set is the encountering thread.
