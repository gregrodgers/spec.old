...
%If an array section with a named pointer is a list item in a \code{map}
...
%occur, then if the corresponding array section is created in the device data
...
corresponds to the named pointer when the effects of the \code{map} clause
occur, then if the corresponding array section is created in the device data
environment: \begin{enumerate}
...
\item If the \plc{map-type} is \code{to} or \code{tofrom}, then:
    ...
    \item The corresponding list item is assigned the value of the original list item.

    \item If any part of the corresponding list item is an attached pointer,
    that part of the corresponding list item will have the value it had immediately
    prior to the effects of the \code{map} clause.
...
\begin{enumerate}
    ...
    \item The original list item is assigned the value of the corresponding list item.

    \item If any part of the corresponding list item is an attached pointer,
    that part of the original list item will have the value it had on entry to
    the region.
