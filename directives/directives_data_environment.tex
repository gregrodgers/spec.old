...
\begin{enumerate}
If the corresponding list item is not an attached corresponding pointer, then the original list item is assigned the value of the corresponding list item.
\end{enumerate}
\end{enumerate}
