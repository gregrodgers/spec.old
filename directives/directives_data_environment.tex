...
\item For each part of the list item that is an attached pointer, that 
      ...
      it had immediately prior to the effect of the \code{map} clause; and
...
\item For each part of the list item that is an attached pointer, that part 
      ...
      to the effect of the \code{map} clause; and
...
item that occurs as a result of the \code{map} clause to avoid race conditions.
