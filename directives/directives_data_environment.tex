...
\item The corresponding pointer variable becomes an \emph{attached pointer}
...
\item If the \plc{map-type} is \code{to} or \code{tofrom}, then:
    \begin{enumerate}
    \item If the corresponding list item is not an attached pointer, then the corresponding list item is assigned the value of the original list item.
\end{enumerate}
\end{enumerate}
