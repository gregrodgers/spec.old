...
\specref{subsec:List Item Privatization}. At the end of a region that
corresponds to a construct for which the \code{reduction} clause was
...
items are privatized in the construct according to \specref{subsec:List
...
\specref{subsec:List Item Privatization}, and an unspecified number of
