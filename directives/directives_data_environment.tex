...
\summary
The \code{linear} clause declares one or more list items to be private to a SIMD 
lane and to have a linear relationship with respect to the iteration space of a loop.
...
\item The \plc{linear-step} expression must be invariant during the execution 
      of the region corresponding to the construct. Otherwise, the execution 
