...
is associated with the corresponding pointer target in the device data
environment.
%The corresponding pointer becomes an attached pointer
%unless it is already associated with the corresponding pointer target.
The corresponding pointer becomes an attached pointer unless it was
associated with the corresponding pointer target prior to a task
encountering the construct associated with the \code{map} clause.
