...
\begin{itemize}
\item If the firstprivate clause is not on a target construct, then a copy constructor is invoked to perform the initialization;
\item If the firstprivate clause is on a target construct, then it is unspecified how many copy constructors, if any, are invoked.
\end{itemize}
