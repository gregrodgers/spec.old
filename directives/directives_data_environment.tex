...
\code{parallel}~\code{for}, \code{taskloop}, \code{distribute}, or
\code{loop} construct may be listed in a \code{private} or \code{lastprivate} clause.
...
\code{parallel}~\code{do}, \code{taskloop}, \code{distribute}, or \code{loop}
