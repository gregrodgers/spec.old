...
\item \plc{iterator-type} is the iterator's type.
\item \plc{range-specification} is of the form \plc{begin, end[, step]} where \plc{begin}, \plc{end} and \plc{step} are expressions of the \plc{iterator-type} type.
\end{itemize}
...
\begin{ccppspecific}
    The \plc{iterator-type} must be an integral or pointer type.
\end{ccppspecific}
\begin{fortranspecific}
    The \plc{iterator-type} must be an integer type.
\end{fortranspecific}
