...
NOTE: This to make structure variables make sense in the mapping algorithm.
According to the algorithm, each structure element gets a ref-count increment,
...
original array section. (detach bottom-up) (door open for shadow pointers).

\item The corresponding pointer variable cannot be modified while it is assigned
the address of the corresponding array section.  (until we support shadow
pointers) 
