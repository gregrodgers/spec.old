...
in the league as if the \code{private} clause had been used. For the
\code{loop} construct, one or more private copies of each list item are created
and initialized for each participating thread, as if the \code{private} clause
had been used. At the end of a region corresponding to an above construct for
