...
\begin{enumerate}
\item If the \plc{map-type} is \code{from} or \code{tofrom} and the corresponding list item is not an attached corresponding pointer, then the original list item is assigned the value of the corresponding list item. 
\end{enumerate}
