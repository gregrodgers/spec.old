...
\item The value of the \plc{dyn-var} internal control variable in the enclosing \code{task} region is \plc{false}
...
exists immediately prior to the construct in the \code{task} region where the
