...
\begin{enumerate}
\item If the \plc{map-type} is \code{from} or \code{tofrom}, [and the corresponding list item is not a attached corresponding pointer (see below)] then the original list item is assigned the value of the corresponding list item. 
\end{enumerate}
...
as an \emph{attached corresponding pointer} variable in the device data
environment.
