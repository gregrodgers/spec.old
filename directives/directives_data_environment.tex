...
\item If a list item in a \code{reduction} or \code{in_reduction} clause
      on a construct is an array section or array element whose base has pointer
...
\item If a list item is an array section, all threads participating in the reduction
...
array section then the base pointer must point to the same variable for all threads of the team.
