...
explicitly specified with the \verb`mapper` map-type-modifier, then the
effective map-type of a list-item will decay to include only the transfers
included in both map types.
