...
\item If a list item that appears in a \code{reduction} clause of a
worksharing construct is an array section or an array element, all threads
that participate in the reduction must use the same array section or array
element.
...
or \code{loop} construct has a reference type then it must bind to the same object
for all threads of the team.

\item If a list item in a \code{reduction} clause on a worksharing
or \code{loop} construct is an array section or an array element then the base
