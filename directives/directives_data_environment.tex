...
tasks that participate in the reduction, which include all implicit tasks in the
corresponding region and all participating explicit tasks that specify an
\code{in_reduction} clause (see \specref{subsubsec:in_reduction clause}).
...
will be complete at the end of the
