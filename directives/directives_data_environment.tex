...
This section presents a directive and several clauses for controlling 
data environments.
...
\item Cray pointees have the same the data-sharing attribute as the storage 
...
\item Variables with \code{const}-qualified type having no mutable member may 
