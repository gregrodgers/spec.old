...
begins to combine its own partial result for a reduction with those of other tasks
and the \plc{reduction-end} event occurs after the task 
finishes combining its partial result for a reduction with those of other tasks.
