...
\item In a \code{target} construct, variables that are not mapped after applying data-mapping attribute rules (see \specref{subsec:Data-mapping Attribute Rules, Clauses, and Constructs}) are firstprivate.
\end{itemize}
...
The reduction data-sharing attribute clauses are explained in Section \ref{subsec:Reduction Clauses and Constructs}.
...
\subsection{Reduction Clauses and Constructs}
\index{reduction clauses}
\label{subsec:Reduction Clauses and Constructs}
...
%%% map
\vspace{-12 pt} %% UGLY HACK
\subsection{Data-mapping Attribute Rules, Clauses, and Constructs}
\label{subsec:Data-mapping Attribute Rules, Clauses, and Constructs}
