...
worksharing construct or \code{loop} construct for which the corresponding region binds to a
parallel region is an array section or an array element, all threads
that participate in the reduction must use the same storage location.
