...
If a list item in a \code{map} clause is a variable of structure type then it is
treated as if each structure element contained in the variable
is a list item in the clause.
...
sibling list}.  The list items in a structure sibling list are treated as
follows:

\begin{itemize}

  \item If a corresponding list item of a structure sibling list item is
