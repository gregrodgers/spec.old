...
\plc{variable-category}.  If \plc{implicit-behavior} is \code{require_present},
each variable in the category specified by \plc{variable-category} is treated as if it were listed in a \code{map(require_present:alloc)} clause.
