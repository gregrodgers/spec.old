...
\item Any IEEE floating-point exception status flag, halting mode, or rounding mode is set prior to a \code{target} region, the settings are unspecified in the region.

\item Any IEEE floating-point exception status flag, halting mode, or rounding mode is set during or in a \code{target} region, the settings are unspecified upon exiting the region.
