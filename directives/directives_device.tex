...
\begin{indentedcodelist}
to(\plc{[[motion-modifier[,]]motion-modifier :]}\plc{locator-list})
from(\plc{[[motion-modifier[,]]motion-modifier :]}\plc{locator-list})
\end{indentedcodelist}

and \plc{motion-modifier} is one of the following:
