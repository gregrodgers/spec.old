...
If \code{device} clause does not appear on the construct, the default device is 
determined by the \plc{default-device-var} ICV.
...
\tools
\omptTarget{\code{target}~\code{update}}{ompt_target_update}
{target-update}{the target task on the host}
