...
\begin{ompcPragma}
#pragma omp declare mapper(\plc{[mapper-identifier [ [},\plc{] mapper-identifier ... ] :]type var})
...
\begin{ompfPragma}
!$omp declare mapper(\plc{[mapper-identifier [ [},\plc{] mapper-identifier ... ]:] type :: var})
...
\begin{itemize}
  ...
  \item \plc{clause} is one of the following:
    \begin{itemize}
      \item \pcode{map(}\plc{[[map-type-modifier[}\pcode{,}\plc{] [map-type-modifier[}\pcode{,}\plc{] ...]] map-type}\pcode{:}\plc{ ] list}\pcode{)}
