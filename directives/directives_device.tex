...
For each list item in a \code{from} clause the value of the corresponding list
item, if it is not an attached pointer, is assigned to the original list item.

For each list item in a \code{to} clause the value of the original list item is
assigned to the corresponding list item if the corresponding list item is not
an attached pointer.
