...
schedule the implementation may assume that depenencies do not exist between any two
logial iterations, so that the iterations may be executed in any order,
