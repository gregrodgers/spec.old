...
If an array section is a list item in a \code{map} clause, the base expression
of the array section is a scalar variable for which the type is pointer, and
that variable has a predetermined data-sharing attribute of firstprivate then
prior to the execution of construct:
...
\item If the list item is a zero-length array section, the correspnding private
...
present in the device data environment, the correspnding private variable
