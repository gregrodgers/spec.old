...
private variable is initialized with the value of the base expression
relative to the corresponding array section in the device data environment
that is created by the \code{map} clause.

\item If the list item is a zero-length array section, the corresponding
private variable is initialized with the value of the base expression relative
to the corresponding array section in the device data environment. If the
