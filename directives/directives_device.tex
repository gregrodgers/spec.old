...
uses_allocator(\plc{allocator}[:{\plc{allocator-traits-array}])
\end{indentedcodelist}
\end{ccppspecific}
...
\item list items that appear in an \code{uses_allocator} cannot appear in another clause in the same construct.
