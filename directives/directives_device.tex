...
of a \plc{target-data-begin} in that thread in the context of the task that 
encounters the construct. Similarly, a thread dispatches a registered 
...
argument for each occurrence of a \plc{target-data-end} in that thread in 
the context of the task that encounters the construct. These callbacks have 
