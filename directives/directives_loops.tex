...
then the binding region is the closely nested \code{teams} region; if 
\plc{binding} is \code{parallel} then the binding region is the closely 
nested \code{parallel} region; and if \plc{binding} is \code{thread} 
