...
\item An \code{atomic} construct, a \code{concurrent} construct, a \code{simd} construct or an \code{ordered} construct with the \code{simd} clause is the only OpenMP
