...
construct is zero and that loop does not enclose the intervening code, the behavior
is unspecified.
...
\code{distribute} construct is zero and that loop does not enclose the intervening code,
the behavior is unspecified.
