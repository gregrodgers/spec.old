...
\subsection{SIMD Constructs}
\label{subsec:SIMD Constructs}
...
determined by \plc{binding}. If the \code{loop} construct is closely
...
\begin{itemize}
  ...
  \item SIMD constructs, see \specref{subsec:SIMD Constructs}.
