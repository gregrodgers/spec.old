...
\plc{range-expr} are evaluated before executing the loop construct. If
\plc{b} or \plc{lb} are loop invariant, they are evaluated before
executing the loop construct. If \plc{b} or \plc{lb} is not loop
invariant, \plc{a1} or \plc{a2} is evaluated before excuting the loop
