...
{\scode{pool\_size}} & Positive integer value & Implementation defined\\
\end{supertabular}
\linenumbers
...
The total amount of storage that an allocator can use is limited by the {\scode{pool\_size}} trait. Requests that would result in using more storage than {\scode{pool\_size}} result in unspecified behavior. 
