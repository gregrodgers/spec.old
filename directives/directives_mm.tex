...
\subsection{Predefined declarations for allocation routines}
\label{subsec:predefined_declarations_for_allocation}
\begin{ccppspecific}
A compliant implementation shall provide a set of \code{declare alloc} directives in a header file called \code{omp\_alloc.h}.
This file shall contain appropriate \code{declare alloc} directives for the following memory allocation routines:
\begin{itemize}
\item \code{malloc}
\item \code{calloc}
\item \code{realloc}
