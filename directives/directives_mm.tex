...
{\scode{alignment}} trait of the allocator. Additional requirements on alignment
...
item, the behavior is implementation defined. Each \plc{list item} allocation 
...
in the \code{allocate} clause. Each \plc{list item} allocation 
will be byte aligned to at least the alignment required by the
base language for the type of that \plc{list item}.

If a memory allocator is unable to fulfill the 
