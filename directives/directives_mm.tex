...
{\scode{partition}} & {\scode{whatever}, \scode{nearest}, \scode{blocked}, \scode{interleaved}} & {\scode{default}}\\
\end{supertabular}
\linenumbers
...
\begin{itemize}
 \item \scode{whatever}: the placement of allocated memory is determined by the execution environment.
