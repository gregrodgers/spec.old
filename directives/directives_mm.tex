...
where \plc{allocator} is an expression of \code{const omp_allocator_handle_t} type.
...
\begin{ccppspecific}
where \plc{allocator} is an expression of the \code{const omp_allocator_handle_t} type.
\end{ccppspecific}
