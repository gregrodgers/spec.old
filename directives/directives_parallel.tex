...
\textbf{if} a \code{thread\_limit} clause exists on a \code{teams} construct associated with an enclosing \code{teams} region

\textbf{then let} \plc{ThreadLimit} be the value of the \code{thread\_limit} clause expression; 
