...
The \code{nontemporal} clause is a hint to the OpenMP implementation that the memory location to which a list item refers is not re-accessed (written or read) within the loop associated with the \code{simd} construct after the first access.
