...
The \code{nontemporal} clause modifier specifies that the storage locations to which the list items refer have low temporal locality outside the iterations in which those storage locations are accessed.
