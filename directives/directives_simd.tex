e% This is an included file. See the master file for more information.
%
...
The \code{safelen} clause defines the maximum number of consecutive logical loop iterations that can be executed concurrently with a SIMD chumk by a SIMD instruction.
