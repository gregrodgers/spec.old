...
The \code{safelen} clause defines the maximum number of consecutive logical loop iterations that can be executed concurrently with a SIMD chunk by a SIMD instruction.
