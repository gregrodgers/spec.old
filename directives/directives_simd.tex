...
The \code{nontemporal} clause modifier is a hint to request that write accesses to the list items within the loop associated with the \code{simd} construct may be written directly to memory using a streaming write instructions without going through a cache.
