...
The \code{nontemporal} clause is a hint to the OpenMP implementation that any of the memory references to the list item within the loop associated with the \code{simd} construct should be accessed through memory, but not through a cache.
