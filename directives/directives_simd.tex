...
\item A \plc{list-item} that appears on a \code{nontemporal} clause must not appear on a \code{firstprivate}, \code{lastprivate}, \code{linear}, or \code{reduction} clause.
