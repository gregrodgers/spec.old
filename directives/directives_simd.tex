...
construct.  If the iteration count of any loop associated with the \code{simd}
construct that does not enclose the intervening code is zero then the behavior
is unspecified.
