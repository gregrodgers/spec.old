...
\begin{itemize}
	...
	thread that executes a remaining child task performs a release flush upon
...
Therefore, if \plc{memory-order-clause} is specified, release and/or acquire
flush operations are implied and permit synchronization between the threads
without the use of explicit \code{flush} directives.
