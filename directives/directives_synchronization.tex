...
\begin{boxedcode}
\#pragma omp atomic \plc{[}seq\_cst\plc{[},\plc{]]} \plc{atomic-clause} \plc{[[},\plc{]}hint(\plc{hint-expression})\plc{]} 
                    \plc{[[},\plc{]}seq\_cst\plc{]} \plc{new-line}
   \plc{expression-stmt}
\end{boxedcode}
...
\begin{boxedcode}
\#pragma omp atomic \plc{[}seq\_cst\plc{]} \plc{[[},\plc{]}hint(\plc{hint-expression})\plc{]} \plc{new-line} 
   \plc{expression-stmt}
\end{boxedcode}
...
\begin{boxedcode}
\#pragma omp atomic \plc{[}seq\_cst\plc{[},\plc{]]} capture \plc{[[},\plc{]}\plc{[}hint(\plc{hint-expression})\plc{]}
                    \plc{[[},\plc{]}seq\_cst\plc{]} \plc{new-line}
    \plc{structured-block}
\end{boxedcode}
...
\begin{boxedcode}
!\$omp atomic \plc{[}seq\_cst\plc{[},\plc{]]} read \plc{[[},\plc{]}hint(\plc{hint-expression})\plc{]} \plc{[[},\plc{]}seq\_cst\plc{]}
...
\begin{boxedcode}
!\$omp atomic \plc{[}seq\_cst\plc{[},\plc{]]} write \plc{[[},\plc{]}hint(\plc{hint-expression})\plc{]}  \plc{[[},\plc{]}seq\_cst\plc{]}
    \plc{write-statement }
\plc{[}!\$omp end atomic\plc{]}
\end{boxedcode}
...
\begin{boxedcode}
!\$omp atomic \plc{[}seq\_cst\plc{[},\plc{]]} update \plc{[[},\plc{]}hint(\plc{hint-expression})\plc{]} \plc{[[},\plc{]}seq\_cst\plc{]}
...
\begin{boxedcode}
!\$omp atomic \plc{[}seq\_cst\plc{]} \plc{[[},\plc{]}hint(\plc{hint-expression})\plc{]} \plc{[[},\plc{]}seq\_cst\plc{]}
    \plc{update-statement }
\plc{[}!\$omp end atomic\plc{]}
\end{boxedcode}
...
\begin{boxedcode}
!\$omp atomic \plc{[}seq\_cst\plc{[},\plc{]]} capture \plc{[[},\plc{]}hint(\plc{hint-expression})\plc{]} \plc{[[},\plc{]}seq\_cst\plc{]}
    \plc{update-statement }
    \plc{capture-statement}
!\$omp end atomic
\end{boxedcode}
