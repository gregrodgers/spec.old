...
\begin{itemize}
\item When a \plc{hint} is provided all lexically distinct atomic operations which
...
\end{itemize}
The rules for combining \code{omp\_synch\_hint}s apply equally to the corresponding \code{omp\_lock\_hint}s.
