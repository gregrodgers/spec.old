...
\begin{fortranspecific}
Accesses to coindexed objects within an image must have a happens before order
(see \specref{subsec:happens-before}) resulting from the synchronization
behavior of the constructs described in this section or the lock routines
described in \specref{sec:Lock Routines}; otherwise, the behavior is
unspecified.
\end{fortranspecific}
