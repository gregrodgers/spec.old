...
strong, write, and read flush properties.

If \plc{memory-order-clause} is \code{acq\_rel}, the flush operation is both
a release flush and an acquire flush.

If \plc{memory-order-clause} is \code{release}, the flush operation is a
release flush.

If \plc{memory-order-clause} is \code{acquire}, the flush operation is an
acquire flush.
