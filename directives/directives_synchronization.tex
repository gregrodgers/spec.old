...
\item During \code{omp_unset_lock} and \code{omp_unset_nest_lock} regions;
...
\item During \code{omp_set_lock}, \code{omp_test_lock}, \code{omp_set_nest_lock}, 
      and \code{omp_test_nest_lock} regions, if the region causes the lock to be set;
