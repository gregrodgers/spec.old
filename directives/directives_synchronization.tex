...
list item if they are the same storage location, or if any of the list items is
\code{omp_all_memory}.
...
sections or the \code{omp_all_memory} reserved item locator.
...
\begin{itemize}
\item List items,
      other than reserved item locators,
...
\item The \code{omp_all_memory} reserved item locator can only be used in a
