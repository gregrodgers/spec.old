...
\item The worksharing-loop region to which an \code{ordered} region arising from an
...
\item During execution of an iteration of a loop or a loop nest within a
    worksharing-loop, \code{simd}, or worksharing-loop SIMD
