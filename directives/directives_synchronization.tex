...
An OpenMP dependence object can be in one of the following states: 
...
\summary
The \code{depobj} construct allows to initalize, update and destroy depend 
objects that represent data dependences. The \code{depobj} construct is a 
stand-alone directive.
...
of \plc{depobj} to initialized. The \plc{depobj} is initialized 
...
specified by \plc{update} clause.
