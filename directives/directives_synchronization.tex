...
Section \ref{subsec:OpenMP Memory Consistency}. Synchronizing flush operations
that are implied on entry to and exit from atomic operations are defined in
Section \ref{subsec:atomic Construct}. Synchronizing flush operations that are
implied at various other locations in an OpenMP program are defined in Section
\ref{subsec:flush Construct}, and they have the following behavior:
