...
strongly-ordered flush. If \plc{memory-order-clause} is present and is \code{seq\_cst},
...
If \plc{memory-order-clause} is \code{acq\_rel}, the flush operation has the
...
If \plc{memory-order-clause} is \code{acquire}, the flush operation has the
