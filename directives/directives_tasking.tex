...
task. It is recommended to execute close to the location of the data elements
specified in \plc{list}. A program that relies on task affinity may have
...
\item At most one \code{affinity} clause can appear on the directive.
