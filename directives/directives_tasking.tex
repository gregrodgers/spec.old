...
There is no \code{ompt\_callback\_parallel\_begin\_t} dispatch for the implicit parallel region;
...
There is no \code{ompt\_callback\_parallel\_end\_t} dispatch for the implicit parallel region;
