...
where \plc{event-handler} is expression of the \code{omp_event_t *} type.
...
where \plc{event-handler} is an integer expression of the \code{omp_event_kind} \plc{kind}
