...
task. The task is recommended to execute closely to the location of the data elements
specified in \plc{list}. A program that relies on the task execution location
