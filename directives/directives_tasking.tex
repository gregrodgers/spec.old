...
If a list item appears in \code{affinity} and \code{firstprivate} clause then data affinity refers to the private copy of the list item.
...
\item \code{ompt_work_taskloop}, see \specref{sec:ompt_work_type_t}.
