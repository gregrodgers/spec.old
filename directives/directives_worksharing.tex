...
region. Only the threads of the team executing the binding \code{parallel} 
...
The \plc{single-end} event occurs after a \code{single} region finishes 
execution of the structured block but before resuming execution of the 
encountering implicit task.
