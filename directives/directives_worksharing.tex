...
made private on the worksharing-loop construct.
\end{fortranspecific}
...
of the associated loops to their respective threads as specified in \ref{tab:Schedule-Values}
the implementation may assume that depenencies do not exist between any two
...
\omptWorksharing{worksharing-loop}{ompt_work_loop}
