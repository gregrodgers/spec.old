...
\descr
Only one of the encountering threads will eecute the strcutured block associated with the \code{single}
construct. The method of choosing a thread to execute the structured block each time the team encounteres the construct
