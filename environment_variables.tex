...
If \plc{chunk} is present, there may be white space on either side of the 
...
a number of threads which is greater than an implementation can support, or 
...
two types of values: either an abstract name describing a set of places 
