...
\item \code{OMP\_ALLOCATOR} sets the \plc{def-allocator-var} ICV that specifies the default 
allocator on the host device.

\item \code{OMP\_TARGET\_ALLOCATOR} sets the \plc{target-def-allocator-var} ICV that specifies the default 
allocator on a target device.
\end{itemize}
...
allocator on the host device for allocation calls, directives and clauses that use default allocation.
The value of this environment variable is a predefined allocator.
...
allocator on a target device for allocation calls, directives and clauses that use default allocation.
The value of this environment variable is a predefined allocator.
