...
initial value of the \plc{nest-var} ICV. The value of this environment variable
must be one of the following: 

{\code{true}|\code{false}}

If the environment variable is set to \code{true}, nested parallelism is enabled; if
