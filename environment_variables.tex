...
allocator for allocation calls, directives and clauses that do not specify an allocator other than those affected by the \plc{target-def-allocator-var} ICV. 
...
allocator on \code{target} constructs clauses that do not specify an allocator.
The value of this environment variable is a predefined allocator from \tabref{tab:Predefined Allocators}. The value of this environment variable is not case sensitive.
