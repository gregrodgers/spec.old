...
element and appears as the array referred to by the array item, where the
array item is the array, is an element of the array, or is an array section
that designates a subset of elements of the array.

For Fortran:
\nopagebreak
For a given array item, a variable that is an array and appears as the array
referred to by the array item, where the array item is the array, is an
element of the array, or is an array section that designates a subset of
...
array item is an element of the array, or is an array section that designates
a subset of elements of the array.
...
where the array item is an element of the array or is an array section that
designates a subset of elements of the array.
\begin{adjustwidth}{-0.75in}{0in}
\begin{note}
