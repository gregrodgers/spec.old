...
A pointer variable in a device data environment to which the effect of a \code{map}
clause assigns the address of an array section. The pointer is an attached
pointer for the duration of the lifetime of the array section in the device
data environment.
\glossarydefend
\bigskip
