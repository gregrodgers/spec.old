...
%of the array.
For a given array item, an lvalue expression (for C/C++) or variable (for
Fortran) that is an array and for which the following conditions are
satisfied:
\begin{itemize}
\item The array is not an element of another array.
\item The lvalue expression (for C/C++) or variable name (for Fortran)
appears as part of the expression for the array item.
\item The array item is specified as the array, as an element of the array, or
as an array section that designates a subset of elements of the array.
\end{itemize} \glossarydefend
...
For a given array element or array section, an lvalue expression (for C/C++)
or variable (for Fortran) that is a pointer and for which the following
conditions are satisfied:
\begin{itemize}
\item The lvalue expression (for C/C++) or variable name (for Fortran) appears
as part of the expression for the array item.
\item The array element or array section is, or is part of, an array section having
contiguous storage, having the same named pointer, and to which the named
pointer points.
\end{itemize}
\begin{adjustwidth}{-0.75in}{0in}
\begin{note}
A given array element or array section cannot have a named pointer if it
has a named array.
\end{note}
\end{adjustwidth}
\glossarydefend
