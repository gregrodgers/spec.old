...
For C/C++:
\nopagebreak
An lvalue expression that is an array but not an array
element and appears as the array referred to by a given array item.
...
the array implicitly referred to by a given array item.
...
\glossaryterm{attached corresponding pointer}
\glossarydefstart
A pointer variable in a device data environment that corresponds
to a named pointer in an array section.
\glossarydefend
\bigskip
