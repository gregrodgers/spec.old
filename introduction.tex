...
%For C/C++:
%\nopagebreak
%For a given array item, an lvalue expression that is an array but not an array
%element that appears as the array referred to by the array item, where the
%array item is the array, is an array section that is a subset of the elements
%of the array, or is an array element that is an element of the array.
%
%For Fortran:
%\nopagebreak
%For a given array item, a variable that is an array that appears as the array
%referred to by the array item, where the array item is the array, is an array
%section that is a subset of the elements of the array, or is an array element
%that is an element of the array.

For a given array item, an lvalue expression that is an array but not an array
element (for C/C++) or a variable that is an array (for Fortran) that appears
as the array referred to by the array item, where the array item is the array,
is an array section that is a subset of the elements of the array, or is an
array element that is an element of the array.
...
%For C/C++:
%\nopagebreak
%For a given array item, an lvalue expression that is a pointer and appears as
%a pointer to an array implicitly referred to by the array item, where the
%array item is an array section that is a subset of the elements of the array
%or is an array element that is an element of the array.
%
%For Fortran:
%\nopagebreak
%For a given array item, a variable that has the \code{POINTER} attribute and
%appears as a pointer to an array implicitly referred to by the array item,
%where the array item is an array section that is a subset of the elements of
%the array or is an array element that is an element of the array.

For a given array item, an lvalue expression that is a pointer (for C/C++) or
a variable that has the \code{POINTER} attribute (for Fortran) that appears as
a pointer to an array implicitly referred to by the array item, where the
array item is an array section that is a subset of the elements of the array
or is an array element that is an element of the array.
...
\begin{adjustwidth}{-0.75in}{0in}
\begin{note}
A given array item cannot have a named pointer if it has a named array.
\end{note}
\end{adjustwidth}
\glossarydefend
