...
corresponding compound statement obtained by enclosing it in \scode{{}
and \scode{}} would be a \emph{structured block}.
\end{itemize}
...
\glossaryterm{unit scope}
\glossarydefstart
In C/C++, a translation unit.

In Fortran, In Fortran, a program, subprogram or module
\glossarydefend
...
\glossarydefstart
In C/C++, a \pcode{\#pragma}, and in Fortran, a comment, that specifies \emph{OpenMP
program} behavior.
...
\glossaryterm{memory}
\glossarydefstart
A place to store and to retrieve variables accessible by OpenMP threads.
\glossarydefend

\glossaryterm{memory space}
\glossarydefstart
A representation of storage resources where is possible to store and retrieve variables.
\glossarydefend
