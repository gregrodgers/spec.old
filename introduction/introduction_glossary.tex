...
\glossarydefstart
Represents some system storage where program variables are variables defined.
\glossarydefend

\glossaryterm{memory allocator}
\glossarydefstart
An OpenMP object that fulfills requests to allocate and deallocate storage from its associated \emph{memory space} for program variables.
\glossarydefend
