...
\begin{itemize}
\item \code{STOP} statements or halting caused by an IEEE exception are allowed
...
\glossarydefstart
A construct that is a shortcut for specifying a \code{target} construct that
encloses another construct.
\glossarydefend
...
\glossarydefstart
An operation that atomically accesses and/or modifies a specific storage location.
\glossarydefend
