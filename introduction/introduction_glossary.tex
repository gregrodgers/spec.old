...
\glossaryterm{memory}
\glossarydefstart
A place to store and to retrieve variables.
\glossarydefend

\glossaryterm{memory space}
\glossarydefstart
%TODO:
A representation of system storage where program variables are defined.
\glossarydefend

\glossaryterm{memory allocator}
\glossarydefstart
An OpenMP object that fulfills requests to allocate and deallocate storage for program variables from its associated \emph{memory space}.
\glossarydefend
