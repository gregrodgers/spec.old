...
\begin{quote}
COMMENT: A given \emph{flush} operation must have one or more \emph{flush properties}.
\end{quote}
\glossarydefend
...
\glossarydefstart
A \emph{flush} that has the \emph{release flush property}.
\glossarydefend

\glossaryterm{acquire flush}
\glossarydefstart
A \emph{flush} that has the \emph{acquire flush property}.
\glossarydefend
