...
\begin{quote}
COMMENT: For C11 and C++11, an \emph{OpenMP thread} is a \emph{thread of
execution}, and all concurrency semantics defined by the base language
with respect to such threads apply to \emph{OpenMP threads}.
\end{quote}
\glossarydefend
