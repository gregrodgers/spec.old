...
expression or array section to refer indirectly to its storage and for which
the implicit array contains the storage of the lvalue expression or array
section.

For Fortran, the data pointer that appears last in the designator for a given
variable or array section and for which the pointer target contains the
storage for the variable or array section.
