...
expression or array section to refer indirectly to its storage and whose
implicit array contains the storage of the lvalue expression or array section.

For Fortran, the data pointer that appears last in the designator for a given
variable or array section and whose pointer target contains the storage for the
variable or array section.
...
and identifiers x\emph{i} have an array type declaration, the \emph{base pointer} is:
(*p0).x0[k1].p1->p2.
\end{quote}
\glossarydefend
...
\glossarydefstart
For C/C++, the \emph{base pointer} of a given lvalue expression or array section, or
...
(*p0).x0[k1].p1->p2[k2].x1[k3].x2[4][0:n],
where identifiers p\emph{i} have a pointer type declaration
and identifiers x\emph{i} have an array type declaration, the \emph{named pointers} are: 
p0, 
(*p0).x0[k1].p1,
and 
(*p0).x0[k1].p1->p2.
...
\glossarydefstart
For C/C++, a non-subscripted array that appears in a given lvalue expression or
array section and contains the storage of the lvalue expression or array
section.

For Fortran, an array without the \code{POINTER} attribute and without a subscript list that
appears in the designator of a given variable or array section and contains the storage
of the variable or array section.
...
(*p0).x0[k1].p1->p2[k2].x1[k3].x2[4][0:n],
where identifiers p\emph{i} have a pointer type declaration
and identifiers x\emph{i} have an array type declaration, the \emph{containing arrays} are:
...
\glossarydefstart
For C/C++, a \emph{containing array} of a given lvalue expression or array section
that does not appear in the expression of any of its other \emph{containing arrays}.

For Fortran, a \emph{containing array} of a given variable or array section
that does not appear in the designator of any of its other \emph{containing arrays}.
...
(*p0).x0[k1].p1->p2[k2].x1[k3].x2[4][0:n],
where identifiers p\emph{i} have a pointer type declaration
and identifiers x\emph{i} have an array type declaration, the \emph{base array} is:
(*p0).x0[k1].p1->p2[k2].x1[k3].x2.
\end{quote}
\glossarydefend
...
\glossarydefstart
For C/C++, a \emph{containing array} of a given lvalue expression or array section, or
