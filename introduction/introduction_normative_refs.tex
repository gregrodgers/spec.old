...
C++17. The following features are not supported:

\begin{itemize}
  \item typename in a template template parameter
  \item New specification for inheriting constructors (DR1941 et al)
  \item Aggregate initialization of classes with base classes
  \item Stricter expression evaluation order
  \item Matching template template parameters to compatible arguments
  \item Differing begin and end types in range-based for
