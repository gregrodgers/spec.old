...
With the exception of the \code{omp_control_tool} runtime library routine for tool control,
...
for \code{omp_control_tool};
all other OMPT functionality is described with C syntax only.

\subsection{OMPD}

%% Seems like saying third-party three times is too much
