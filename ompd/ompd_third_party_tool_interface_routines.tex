...
The OMPD API version number is equal to the value of the _OPENMP macro defined 
...
Fortran integer parameter openmp_version.
...
\constraints
Any string that \plc{next_icv_name} returns must be immutable and defined
