...
\item A global variable of type \code{const omp\_allocator\_t *} for each predefined memory allocator in \tabref{tab:Predefined Allocators}. These are special variables that cannot be modified nor they can be hidden by inner scopes.
