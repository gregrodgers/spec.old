...
\item A global variable of type \code{const omp\_allocator\_t *} for each predefined memory allocator in \tabref{tab:Predefined Allocators}. 
...
\item An \code{integer} \code{parameter} variable of kind \code{omp\_allocator\_kind} for each predefined memory allocator in \tabref{tab:Predefined Allocators}.
