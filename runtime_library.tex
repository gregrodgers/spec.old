...
\item A global variable of type \code{\omp_allocator\_t *} for each predefined memory allocator in Table~\ref{tab:Predefined Allocators} in page \pageref{tab:Predefined Allocators}.
