...
\subsection{\code{omp_target_alloc}}
...
\subsection{\code{omp_target_free}}
...
\subsection{\code{omp_target_is_present}}
...
\subsection{\code{omp_target_memcpy}}
...
\subsection{\code{omp_target_memcpy_rect}}
...
\subsection{\code{omp_target_associate_ptr}}
...
\subsection{\code{omp_target_disassociate_ptr}}
