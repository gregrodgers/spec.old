...
type(c_ptr) function omp_target_alloc(\plc{size}, \plc{device_num})
use, intrinsic :: iso_c_binding, only : c_ptr
integer, intent(in) :: \plc{size}
integer, intent(in) :: \plc{device_num}
\end{ompfSubroutine}
\end{fortranspecific}
...
\begin{fortranspecific}
\begin{ompfSubroutine}
subroutine omp_target_free(\plc{device_ptr}, \plc{device_num})
use, intrinsic :: iso_c_binding, only : c_ptr
type(c_ptr) :: \plc{device_ptr}
integer, intent(in) :: \plc{device_num}
\end{ompfSubroutine}
\end{fortranspecific}
...
\begin{fortranspecific}
\begin{ompfFunction}
integer function omp_target_is_present(\plc{ptr}, \plc{device_num})
use, intrinsic :: iso_c_binding, only : c_ptr
...
\begin{fortranspecific}
\begin{ompfFunction}
integer function omp_target_memcpy(\plc{dst}, \plc{src}, \plc{length}, &
  \plc{dst_offset}, \plc{src_offset}, \plc{dst_device_num}, \plc{src_device_num})
use, intrinsic :: iso_c_binding, only : c_ptr
type(c_ptr), value :: \plc{dst}
type(c_ptr), value :: \plc{src}
integer, intent(in) :: \plc{length}
integer, intent(in) :: \plc{dst_offset}
integer, intent(in) :: \plc{src_offset}
integer, intent(in) :: \plc{dst_device_num}
integer, intent(in) :: \plc{src_device_num}
\end{ompfFunction}
\end{fortranspecific}
...
type(c_ptr), value :: \plc{dst}
type(c_ptr), value :: \plc{src}
integer(c_size_t), value :: \plc{length}
integer(c_size_t), value :: \plc{dst_offset}
integer(c_size_t), value :: \plc{src_offset}
integer(c_int), value :: \plc{dst_device_num}
integer(c_int), value :: \plc{src_device_num}
\end{ompfFunction}
\end{fortranspecific}
...
\begin{fortranspecific}
\begin{ompfFunction}
integer function omp_target_memcpy_rect(\plc{dst}, \plc{src}, \plc{element_size}, &
  \plc{num_dims}, \plc{volume}, \plc{dst_offsets}, \plc{src_offsets}, \plc{dst_dimensions}, \plc{src_dimensions}, &
  \plc{dst_device_num}, \plc{src_device_num})
use, intrinsic :: iso_c_binding, only : c_ptr
type(c_ptr), value :: \plc{dst}
type(c_ptr), value :: \plc{src}
integer, intent(in) :: \plc{element_esize}
integer, intent(in) :: \plc{num_dims}
integer, intent(in) :: \plc{volume}(*)
integer, intent(in) :: \plc{dst_offsets}(*)
integer, intent(in) :: \plc{src_offsets}(*)
integer, intent(in) :: \plc{dst_dimensions}(*)
integer, intent(in) :: \plc{src_dimensions}(*)
integer, intent(in) :: \plc{dst_device_num}
integer, intent(in) :: \plc{src_device_num}
\end{ompfFunction}
\end{fortranspecific}
...
type(c_ptr), value :: \plc{dst}
type(c_ptr), value :: \plc{src}
integer(c_size_t), value :: \plc{element_esize}
integer(c_int), value :: \plc{num_dims}
integer(c_size_t), intent(in) :: \plc{volume}(*)
integer(c_size_t), intent(in) :: \plc{dst_offsets}(*)
integer(c_size_t), intent(in) :: \plc{src_offsets}(*)
integer(c_size_t), intent(in) :: \plc{dst_dimensions}(*)
integer(c_size_t), intent(in) :: \plc{src_dimensions}(*)
integer(c_int), value :: \plc{dst_device_num}
integer(c_int), value :: \plc{src_device_num}
\end{ompfFunction}
\end{fortranspecific}
...
\code{NULL} pointers (or \code{C_NULL_PTR}, for Fortran), the routine
...
\begin{fortranspecific}
\begin{ompfFunction}
integer function omp_target_associate_ptr(\plc{host_ptr}, \plc{device_ptr}, &
  \plc{size}, \plc{device_offset}, \plc{device_num})
use, intrinsic :: iso_c_binding, only : c_ptr
type(c_ptr), value :: \plc{host_ptr}
type(c_ptr), value :: \plc{device_ptr}
integer, intent(in) :: \plc{size}
integer, intent(in) :: \plc{device_offset}
integer, intent(in) :: \plc{device_num}
\end{ompfFunction}
\end{fortranspecific}
...
\begin{ompfFunction}
integer function omp_target_associate_ptr(\plc{host_ptr}, \plc{device_ptr}, &
  \plc{size}, \plc{device_offset}, \plc{device_num}) bind(c)
use, intrinsic :: iso_c_binding, only : c_ptr, c_size_t, c_int
type(c_ptr), value :: \plc{host_ptr}
type(c_ptr), value :: \plc{device_ptr}
integer(c_size_t), value :: \plc{size}
integer(c_size_t), value :: \plc{device_offset}
integer(c_int), value :: \plc{device_num}
\end{ompfFunction}
\end{fortranspecific}
...
\begin{fortranspecific}
\begin{ompfFunction}
integer function omp_target_disassociate_ptr(\plc{ptr}, \plc{device_num})
use, intrinsic :: iso_c_binding, only : c_ptr
type(c_ptr), value :: \plc{ptr}
integer, intent(in) :: \plc{device_num}
\end{ompfFunction}
