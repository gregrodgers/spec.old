...
from within any explicit \code{parallel} or \code{teams} region, the binding
...
This routine has the described effect only when called from a sequential part of
the program. When called from within an explicit \code{parallel} or \code{teams}
