...
\begin{itemize}
\item The routine may only be called in the sequential part when all 
      explicit tasks have finalized execution. Calling the routine 
      in any other circumstances results in unspecified behavior.
\end{itemize}
