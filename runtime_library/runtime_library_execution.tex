...
\summary
The \code{omp_set_nested} routine enables or disables nested parallelism by setting the
...
\summary
The \code{omp_get_nested} routine returns whether nested parallelism is
...
\subsection{\hcode{omp_get_max_active_levels_supported}}
\index{omp_get_max_active_levels_supported@{\code{omp_get_max_active_levels_supported}}}
\label{subsec:omp_get_max_active_levels_supported}

\summary
The \code{omp_get_max_active_levels_supported} routine returns the maximum
number of active levels supported by the implementation.
...
\binding
The binding task set for an \code{omp_get_max_active_levels_supported}
region is the generating task.

\effect
The \code{omp_get_max_active_levels_supported} routine returns the maximum
number of active levels supported by the implementation. The
value returned by the \code{omp_get_max_active_levels_supported} is
...
\item \code{omp_get_max_active_levels_supported} routine, see
