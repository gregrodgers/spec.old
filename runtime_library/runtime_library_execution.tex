...
\subsection{\code{omp_set_num_threads}}
...
\subsection{\code{omp_get_num_threads}}
...
\subsection{\code{omp_get_max_threads}}
...
\subsection{\code{omp_get_thread_num}}
...
\subsection{\code{omp_get_num_procs}}
...
\subsection{\code{omp_in_parallel}}
...
\bigskip
\subsection{\code{omp_set_dynamic}}
...
\subsection{\code{omp_get_dynamic}}
...
\subsection{\code{omp_get_cancellation}}
...
\subsection{\code{omp_set_nested}}
...
\subsection{\code{omp_get_nested}}
...
\subsection{\code{omp_set_schedule}}
...
\subsection{\code{omp_get_schedule}}
...
\subsection{\code{omp_get_thread_limit}}
...
\subsection{\code{omp_set_max_active_levels}}
...
\subsection{\code{omp_get_max_active_levels}}
...
\subsection{\code{omp_get_ancestor_thread_num}}
...
\subsection{\code{omp_get_team_size}}
...
\subsection{\code{omp_get_active_level}}
...
\subsection{\code{omp_get_proc_bind}}
...
\subsection{\code{omp_get_num_places}}
...
\subsection{\code{omp_get_place_num_procs}}
...
\subsection{\code{omp_get_place_proc_ids}}
...
\subsection{\code{omp_get_place_num}}
...
\subsection{\code{omp_get_partition_num_places}}
...
\subsection{\code{omp_get_partition_place_nums}}
...
\subsection{\code{omp_set_affinity_format}}
...
\subsection{\code{omp_get_affinity_format}}
...
\subsection{\code{omp_display_affinity}}
...
\subsection{\code{omp_capture_affinity}}
...
\subsection{\code{omp_set_default_device}}
...
\subsection{\code{omp_get_default_device}}
...
\subsection{\code{omp_get_num_devices}}
...
\subsection{\code{omp_get_num_teams}}
\index{omp\@{\code{omp_get_num_teams}}}
...
\subsection{\code{omp_get_team_num}}
...
\subsection{\code{omp_is_initial_device}}
...
\subsection{\code{omp_get_initial_device}}
...
\subsection{\code{omp_get_max_task_priority}}
