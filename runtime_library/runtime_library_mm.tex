...
\summary
The \code{omp\_set\_default\_allocator} sets the default allocator to be used by allocation calls, directives and clauses that use default allocation.
...
The \plc{allocator} argument must be an allocator returned by the \code{omp\_init\_allocator} routine.
...
\summary
The \code{omp\_get\_default\_allocator} returns the allocator to be used by allocation calls, directives and clauses that use default allocation.
