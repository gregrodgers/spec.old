...
typedef enum {
  ...
  OMP_ATV_TRUE = 1,    /* Reserver for future use */
  OMP_ATV_SHARED,
  OMP_ATV_EXCLUSIVE,
  OMP_ATV_ALL,
  OMP_ATV_THREAD,
...
integer(kind=omp_alloctrait_key_kind), &
   parameter :: omp_atk_threadmodel
integer(kind=omp_alloctrait_key_kind), &
   parameter :: omp_atk_alignment
integer(kind=omp_alloctrait_key_kind), &
   parameter :: omp_atk_access
integer(kind=omp_alloctrait_key_kind), &
   parameter :: omp_atk_fallback
integer(kind=omp_alloctrait_key_kind), &
   parameter :: omp_atk_fb_data
...
integer(kind=omp_alloctratit_val_kind), &
  parameter :: omp_atv_shared
integer(kind=omp_alloctratit_val_kind), &
  parameter :: omp_atv_exclusive
integer(kind=omp_alloctratit_val_kind), &
  parameter :: omp_atv_all
integer(kind=omp_alloctratit_val_kind), &
  parameter :: omp_atv_thread
integer(kind=omp_alloctratit_val_kind), &
  parameter :: omp_atv_pteam
integer(kind=omp_alloctratit_val_kind), &
  parameter :: omp_atv_cgroup
integer(kind=omp_alloctratit_val_kind), &
  parameter :: omp_atv_default_fb
integer(kind=omp_alloctratit_val_kind), &
  parameter :: omp_atv_null_fb
integer(kind=omp_alloctratit_val_kind), &
  parameter :: omp_atv_abort_fb
integer(kind=omp_alloctratit_val_kind), &
  parameter :: omp_atv_allocator_fb
...
The \code{omp_init_allocator} routine creates a new allocator that is associated with the memory space represented by the \plc{memspace} handle. 
...
traits in the \plc{traits} argument is specified by the \plc{ntraits} argument. Specifying the same allocator trait more than once results in unspecified behavior. The routine returns a handle for the created allocator. 
...
The \code{omp_destroy_allocator} routine releases all resources used to implement the allocator handle. Also, any memory allocated by the allocator but not yet deallocated  is deallocated by this routine.
