...
integer(kind=omp_alloctrait_distribute_kind), &
   parameter :: omp_atk_distribute = 5
...
integer(kind=omp_alloctrait_val_kind), &
  parameter :: omp_atv_nearest = 11
integer(kind=omp_alloctrait_val_kind), &
  parameter :: omp_atv_blocked = 12
integer(kind=omp_alloctrait_val_kind), &
  parameter :: omp_atv_cyclic = 13
