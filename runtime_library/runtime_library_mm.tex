...
\summary
The \code{omp\_set\_target\_default\_allocator} routine sets the default memory allocator to be used by an \code{allocate} clauses on \code{target} constructs that do not specify an allocator.
...
\summary
The \code{omp\_get\_target\_default\_allocator} routine returns the memory allocator to be used by an \code{allocate} clauses on \code{target} constructs that do not specify an allocator.
