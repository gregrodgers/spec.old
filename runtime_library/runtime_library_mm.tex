...
Unless a \code{requires} construct with the \code{dynamic_allocators} clause is present in the same translation unit, using this routine in a target region results in unspecified behavior.
