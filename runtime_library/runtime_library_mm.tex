...
integer(kind=omp_alloctrait_val_kind), &
  parameter :: omp_atv_whatever = 11
integer(kind=omp_alloctrait_val_kind), &
  parameter :: omp_atv_nearest = 12
integer(kind=omp_alloctrait_val_kind), &
  parameter :: omp_atv_blocked = 13
integer(kind=omp_alloctrait_val_kind), &
  parameter :: omp_atv_cyclic = 14
