...
Unless a \code{requires} directive with the \code{dynamic_allocators} clause is present in the same unit scope, using this routine in a \code{target} region results in unspecified behavior.
