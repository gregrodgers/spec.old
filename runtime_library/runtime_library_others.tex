...
This section describes a routine that supports OpenMP event objects. OpenMP 
event objects must be accessed only through this routine or through the 
\code{detach} clause of the \code{task} construct; programs that otherwise 
access OpenMP event objects are non-conforming.
