...
\subsection{\code{omp_init_lock} and \code{omp_init_nest_lock}}
...
\subsection[\code{omp_init_lock_with_hint} and \\
\code{omp_init_nest_lock_with_hint}]{\code{omp_init_lock_with_hint} and \\
...
\subsection[\code{omp_destroy_lock} and \code{omp_destroy_nest_lock}]{\code{omp_destroy_lock} and\\ \code{omp_destroy_nest_lock}}
...
\subsection{\code{omp_set_lock} and \code{omp_set_nest_lock}}
...
\subsection{\code{omp_unset_lock} and \code{omp_unset_nest_lock}}
...
\subsection{\code{omp_test_lock} and \code{omp_test_nest_lock}}
