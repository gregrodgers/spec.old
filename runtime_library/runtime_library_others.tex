...
integer (kind=omp_event_kind) \plc{event}
\end{ompfFunction}
\end{fortranspecific}
...
The effect of this routine is to fulfill the event passed as an argument to the routine. The effect of fulfilling the event will depend on how the event was created. The event is destroyed and cannot be accessed after calling this routine.
