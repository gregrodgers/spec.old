...
a tool starts or restarts data collection when a code
region of interest is encountered, pauses data collection when
leaving the region of interest,
flushes any data that it has collected so far, or
...
values strictly smaller than -64; an application may assume that any negative return value
...
A tool may return other positive values strictly greater than 64 that are tool-defined.
