...
{\code|omp_control_tool_start|} & Start or
...
{\code|omp_control_tool_pause|} & Temporarily
turn monitoring off. If monitoring is already off, it is idempotent.\\
{\code|omp_control_tool_flush|} & Flush any data buffered by a tool.
This command may be applied whether monitoring is on or off.\\
{\code|omp_control_tool_end|} & Turn monitoring off permanently;
