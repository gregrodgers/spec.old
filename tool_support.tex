...
The \callbackarg{} \plc{codeptr_ra} is used to relate the implementation
...
\newcommand{\ompttype}[1]{\subsubsubsection{#1}}  % section 4.5.7
\newcommand{\ompttoolsignature}[1]{\subsubsection{#1}}  % section 4.8.2
\newcommand{\omptcallbacksignature}[1]{\subsubsubsection{#1}}  % section 4.8.2
\newcommand{\omptruntimeentrypoint}[1]{\subsubsubsection{#1}}  % sections 4.9.*
\newcommand{\ompteventswithoutdirectives}[1]{\littleheader{#1}}

\newcommand{\ompdsection}[1]{\section{#1}}  % section 4.9
\newcommand{\ompdsubsection}[1]{\subsubsection{#1}}  % section 4.9.1
\newcommand{\ompdcallbacksignature}[1]{\subsubsubsection{#1}} 
