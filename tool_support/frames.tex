...
The \plc{exit_frame} field of a \code{omp_frame_t} object contains
...
The \plc{enter_frame} field of a \code{omp_frame_t} object contains
...
the \plc{enter_frame_flags} field indicates whether the provided frame
information points to a runtime or an application frame address;
the \plc{flags} fields also specifies the kind of information that is 
provided to identify the respective frame; 
the \plc{flags} fields is a disjunction of values in the
