...
\begin{enumerate}
\item
  the environment variable \code{OMPD\_ENABLED} is set
\item
  ...
  it will check to see whether the \code{ompd\_enable} function
...
\code{ompd\_enable} as a convenience to programmers.
...
\item
  \code{ompd\_enable}, \specref{ompd:ompd_enable}
\item
...
\begin{itemize}
	...
	%\item \code{ompd\_enable}, \specref{ompd:ompd_enable}
