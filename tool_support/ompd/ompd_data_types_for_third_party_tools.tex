...
\begin{itemize}
	...
	%CUDA SDK package.
	\item
	Otherwise, the segment value is specific to the architecture of the target device.
\end{itemize}
...
the OMPD implementation, and are opaque to the using tool. The following define the OMPD 
handle types:
