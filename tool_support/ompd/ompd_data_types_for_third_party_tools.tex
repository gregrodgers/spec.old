...
\summary
The \code{omp_device_t} type provides information about OpenMP devices.
...
via the \code{omp_device_t} type, which is a pointer to where the device 
...
\summary
The \code{ompd_scope_t} type describes OMPD scope types for OMPD tool 
interface routines.
