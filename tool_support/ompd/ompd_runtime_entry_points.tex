...
\summary
The OpenMP runtime must execute through
\code{ompd_bp_thread_begin} at the \plc{thread-begin} and the \plc{initial-thread-begin} event.
...
\summary
The OpenMP runtime must execute through
\code{ompd_bp_thread_end} at the \plc{thread-end} and the \plc{initial-thread-end} event.
