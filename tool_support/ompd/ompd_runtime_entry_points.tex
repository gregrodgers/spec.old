...
\label{subsubsec:event-notification}
...
\label{subsubsubsec:ompd_bp_parallel_begin}
...
\item
  \code{ompd_get_parallel_function}, \specref{subsubsubsec:ompd_get_parallel_function}
\item
  \code{ompd_get_num_threads}, \specref{subsubsubsec:ompd_get_num_threads}
\item
...
\label{subsubsubsec:ompd_bp_parallel_end}
...
\label{subsubsubsec:ompd_bp_task_begin}
...
%REDEFINITION \label{subsec:runtime-entry-points-for-ompd}
...
\item
  Enabling the Runtime for OMPD, \specref{subsubsec:enabling-ompd}
\end{itemize}
