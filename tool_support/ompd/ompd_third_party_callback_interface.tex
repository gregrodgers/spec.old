...
\item
  \code{ompd_thread_id_kind_t}, \specref{ompd:ompd_thread_id_kind_t}
\item
  \code{ompd_size_t}, \specref{subsubsubsec:ompd_size_t}
\item
...
\subsubsubsection{\hcode{ompd_callback_get_address_space_context_for_thread_fn_t}}
...
% broken.  We probably don't wantthat, but instead want just a plain
% linebreak without the "-".
\index{ompd_callback_get_address_space_context_for_thread_fn_t@{{\scode{ompd_callback_get_address_space_context_\discretionary{}{}{}for_thread_fn_t}}}}
...
\subsubsubsection{\hcode{ompd_callback_get_process_context_for_address_space_context_fn_t}}
...
% broken.  We probably don't wantthat, but instead want just a plain
% linebreak without the "-".
\index{ompd_callback_get_process_context_for_context_fn_t@{{\scode{ompd_callback_get_process_context_for_\discretionary{}{}{}context_fn_t}}}}
...
\begin{itemize}
\item
  OMPD --- Overivew, \specref{sec:ompd-overview}
\end{itemize}
...
The \plc{symbol_name} supplied by the OMPD plugin is used verbatim by the tool, and in particular, 
...
\subsubsection{\hcode{ompd_callback_print_string_fn_t}}
...
\item
  \code{ompd_callback_print_string_fn_t}, \specref{subsubsec:ompd_callback_print_string_fn_t}
\item
  \code{ompd_callback_sizeof_fn_t}, \specref{subsubsubsec:ompd_callback_sizeof_fn_t}
\item
  \code{ompd_callback_symbol_addr_fn_t}, \specref{subsubsec:ompd_callback_symbol_addr_fn_t}
\item
...
\item
  \code{ompd_callback_get_address_space_context_for_thread_fn_t}, \specref{subsubsubsec:ompd_callback_get_address_space_context_for_thread_fn_t}
\item
  \code{ompd_callback_get_process_context_for_address_space_context_fn_t}, \specref{subsubsubsec:ompd_callback_get_process_context_for_address_space_context}
\end{itemize}
