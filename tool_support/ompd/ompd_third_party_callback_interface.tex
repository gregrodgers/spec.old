...
\begin{boxedcode}
typedef struct \{
  ompd\_dmemory\_alloc\_fn\_t   d\_alloc\_memory;
  ompd\_dmemory\_free\_fn\_t    d\_free\_memory;
  ompd\_print\_string\_fn\_t    print\_string;
  ompd\_tsizeof\_prim\_fn\_t    t\_sizeof\_prim\_type;
  ompd\_tsymbol\_addr\_fn\_t    t\_symbol\_addr\_lookup;
  ompd\_tmemory\_read\_fn\_t    t\_read\_memory;
  ompd\_tmemory\_write\_fn\_t   t\_write\_memory;
  ompd\_target\_host\_fn\_t     target\_to\_host;
  ompd\_target\_host\_fn\_t     host\_to\_target;
  ompd\_get\_thread\_context\_for\_osthread\_fn\_t
                            get\_thread\_context\_for\_osthread:
  ompd\_get\_address\_space\_context\_for\_thread\_fn\_t
                            get\_address\_space\_context\_for\_thread;
\} ompd\_callbacks\_t;
\end{boxedcode}
\cspecificend
}
