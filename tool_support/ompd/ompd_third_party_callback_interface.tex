...
\index{ompd_callback_memory_alloc_fn_t@{\code{ompd_callback_memory}\-\code{_al}\-\code{loc}\-\code{_fn_t}}}
...
\index{ompd_callback_memory_free_fn_t@{\code{ompd_callback_memory}\-\code{_free}\-\code{_fn_t}}}
...
\subsubsubsection{\hcode{ompd_callback_get_thread_context_for}\-\hcode{_thread}\-\hcode{_id}\-\hcode{_fn_t}}
...
\index{ompd_callback_get_thread_context_for_thread_id_fn_t@{{\code{ompd_callback_get_thread}\-\code{_con}\-\code{text}\-\code{_for}\-\code{_thread}\-\code{_id}\-\code{_fn_t}}}}
...
\index{ompd_callback_sizeof_fn_t@{\code{ompd_callback}\-\code{_sizeof}\-\code{_fn_t}}}
...
\index{ompd_callback_symbol_addr_fn_t@{\code{ompd_callback_symbol}\-\code{_addr}\-\code{_fn_t}}}
...
\index{ompd_callback_memory_read_fn_t@{\code{ompd_callback_memory}\-\code{_read}\-\code{_fn_t}}}
...
\index{ompd_callback_memory_write_fn_t@{\code{ompd_callback_memory}\-\code{_write}\-\code{_fn_t}}}
...
\subsubsection{Data Format Conversion: \hcode{ompd_callback_device_host_fn_t}}
\label{subsubsec:data-format-conversion}
\label{subsubsubsec:ompd_callback_device_host_fn_t}
\index{ompd_callback_device_host_fn_t@{\code{ompd_callback_device}\-\code{_host}\-\code{_fn_t}}}
...
\subsubsection{Output: \hcode{ompd_callback_print_string_fn_t}}
\label{subsubsec:output}
\label{subsubsubsec:ompd_callback_print_string_fn_t}
\index{ompd_callback_print_string_fn_t@{\code{ompd_callback_print}\-\code{_string}\-\code{_fn_t}}}
