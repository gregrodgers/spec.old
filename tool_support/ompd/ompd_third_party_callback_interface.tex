...
\label{ompd:ompd_get_thread_context_for_osthread_fn_t}
...
\item
  \code{ompd\_device\_host\_fn\_t}, \specref{ompd:ompd_device_host_fn_t}
\item
  \code{ompd\_get\_thread\_context\_for\_osthread\_fn\_t}, \specref{ompd:ompd_get_thread_context_for_osthread_fn_t}
\item
