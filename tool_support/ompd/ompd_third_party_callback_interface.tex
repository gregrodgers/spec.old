...
\summary
The type signature of the callback routine provided by the
third party tool the OMPD library can use to map a native
...
This callback maps a native thread identifier within the address
...
that maps a native thread identifier to a tool thread context.
