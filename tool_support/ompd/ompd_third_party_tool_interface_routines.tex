...
\code{ompd_rel_display_control_vars} to release the vector and strings.
...
On return, the location to which the \plc{more} argument has the value of $1$
whenever one or more ICV are left in the enumeration. on return, that location
