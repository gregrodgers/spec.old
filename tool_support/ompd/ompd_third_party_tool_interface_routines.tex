...
argument specifies the kind of scope provided in \plc{handle}. The \plc{icv_name}
argument specifies the name of the requested ICV. On return, the \plc{icv_value}
