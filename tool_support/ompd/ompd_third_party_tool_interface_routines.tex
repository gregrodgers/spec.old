...
\ompdcallbacksignature{\code{ompd_initialize}}
...
\ompdcallbacksignature{\code{ompd_get_version}}
...
\ompdcallbacksignature{\code{ompd_get_version_string}}
...
\ompdcallbacksignature{\code{ompd_finalize}}
...
\ompdcallbacksignature{\code{ompd_process_initialize}}
...
\ompdcallbacksignature{\code{ompd_device_initialize}}
...
\begin{itemize}
	...
	\item \code{ompd_size_t} type, see \specref{ompd:ompd_size_t}.
	\item \code{ompd_address_space_handle_t} type, see 
	\specref{ompd:ompd_address_space_handle_t}.
\end{itemize}


\ompdcallbacksignature{\code{ompd_release_address_space_handle}}
...
\ompdcallbacksignature{\code{ompd_get_num_procs}}
...
\crossreferences	
\begin{itemize}
	\item \code{ompd_address_space_handle_t} type, see \specref{ompd:ompd_address_space_handle_t}.
	\item \code{omp_get_num_procs}, see \specref{subsec:omp_get_num_procs}.
\end{itemize}

\ompdcallbacksignature{\code{ompd_get_thread_limit}}
...
\ompdcallbacksignature{\code{ompd_get_thread_in_parallel}}
...
\crossreferences
\begin{itemize}
	\item \code{ompd_parallel_handle_t} type, see \specref{ompd:ompd_parallel_handle_t}.
	\item \code{ompd_thread_handle_t} type, see \specref{ompd:ompd_thread_handle_t}.
\end{itemize}

% SUBSUMED by  ompd\_get\_thread\_in\_parallel
%
%
%\ompdcallbacksignature{\code{ompd_get_master_thread_in_parallel}}
...
\ompdcallbacksignature{\code{ompd_get_thread_handle}}
...
\ompdcallbacksignature{\code{ompd_release_thread_handle}}
...
\ompdcallbacksignature{\code{ompd_thread_handle_compare}}
...
\ompdcallbacksignature{\code{ompd_get_thread_handle_string_id}}
...
\ompdcallbacksignature{\code{ompd_get_thread_id}}
...
\ompdcallbacksignature{\code{ompd_get_current_parallel_handle}}
...
\ompdcallbacksignature{\code{ompd_get_enclosing_parallel_handle}}
...
\ompdcallbacksignature{\code{ompd_get_task_parallel_handle}}
...
\crossreferences
\begin{itemize}
	\item \code{ompd_task_handle_t} type, see \specref{ompd:ompd_task_handle_t}.
	\item \code{ompd_parallel_handle_t} type, see \specref{ompd:ompd_parallel_handle_t}.
\end{itemize}

\ompdcallbacksignature{\code{ompd_release_parallel_handle}}
...
\ompdcallbacksignature{\code{ompd_parallel_handle_compare}}
...
\ompdcallbacksignature{\code{ompd_get_parallel_handle_string_id}}
...
\ompdcallbacksignature{\code{ompd_get_current_task_handle}}
...
\ompdcallbacksignature{\code{ompd_get_generating_ancestor_task_handle}}
...
\ompdcallbacksignature{\code{ompd_get_scheduling_ancestor_task_handle}}
...
\ompdcallbacksignature{\code{ompd_get_implicit_task_in_parallel}}
...
\ompdcallbacksignature{\code{ompd_release_task_handle}}
...
\ompdcallbacksignature{\code{ompd_task_handle_compare}}
...
\ompdcallbacksignature{\code{ompd_get_task_handle_string_id}}
...
\ompdcallbacksignature{\code{ompd_get_num_threads}}
...
\begin{itemize}
	\item \code{ompd_parallel_handle_t} type, see \specref{ompd:ompd_parallel_handle_t}.
	\item \code{ompd_word_t} type, see \specref{ompd:ompd_word_t}.
\end{itemize}

\ompdcallbacksignature{\code{ompd_get_parallel_function}}
...
\begin{itemize}
	\item \code{ompd_parallel_handle_t} type, see \specref{ompd:ompd_parallel_handle_t}.
	\item \code{ompd_address_t} type, see \specref{ompd:ompd_address_t}.
\end{itemize}


\ompdcallbacksignature{\code{ompd_get_level}}
...
\ompdcallbacksignature{\code{ompd_get_active_level}}
...
%ompd_rd_t ompd_get_parallel_function(
  %  ompd_parallel_handle_t *\plc{parallel_handle},
  /* IN */
  %  ompd_address_t *\plc{entry_point}                             /* OUT */
  %
);
%\end{ompSyntax}
%\cspecificend
...
\ompdcallbacksignature{\code{ompd_get_task_function}}
...
\ompdcallbacksignature{\code{ompd_get_max_threads}}
...
\ompdcallbacksignature{\code{ompd_get_thread_num}}
...
\ompdcallbacksignature{\code{ompd_in_parallel}}
...
\ompdcallbacksignature{\code{ompd_in_final}}
...
\ompdcallbacksignature{\code{ompd_get_dynamic}}
...
\ompdcallbacksignature{\code{ompd_get_nested}}
...
\ompdcallbacksignature{\code{ompd_get_max_active_levels}}
...
\ompdcallbacksignature{\code{ompd_get_schedule}}
...
\begin{itemize}
	\item \code{ompd_task_handle_t} type, see \specref{ompd:ompd_task_handle_t}.
	\item \code{ompd_sched_t} type, see \specref{ompd:ompd_sched_t}.
	\item \code{ompd_word_t} type, see \specref{ompd:ompd_word_t}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\ompdcallbacksignature{\code{ompd_get_proc_bind}}
...
\begin{itemize}
	\item \code{ompd_task_handle_t} type, see \specref{ompd:ompd_task_handle_t}.
	\item \code{ompd_proc_bind_t} type, see \specref{ompd:ompd_proc_bind_t}.
	\item \plc{bind-var} ICV, see \specref{sec:Internal Control Variables}.
\end{itemize}

\ompdcallbacksignature{\code{ompd_is_implicit}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\ompdcallbacksignature{\code{ompd_get_task_frame}}
...
\ompdcallbacksignature{\code{ompd_get_state}}
...
%ompd\_thread\_handle\_t *\plc{thread_handle}, %/* IN */
%ompd\_state\_t *\plc{state}, %/* OUT */
%ompd\_wait\_id\_t    *\plc{wait_id} % /* OUT */
...
\begin{itemize}
	...
	\item \code{ompd_wait_id_t} type, see \specref{ompd:ompd_wait_id_t}.
\end{itemize}
...
\ompdcallbacksignature{\code{ompd_get_display_control_vars}}
...
\begin{itemize}
	\item \code{ompd_address_space_handle_t} type, see \specref{ompd:ompd_address_space_handle_t}.
	\item \code{ompd_release_display_control_vars} type, see \specref{ompd:ompd_release_display_control_vars}.
\end{itemize}


\ompdcallbacksignature{\code{ompd_release_display_control_vars}}
...
\crossreferences
\begin{itemize}
	\item \code{ompd_get_display_control_vars} type, see \specref{ompd:ompd_get_display_control_vars}.
\end{itemize}
