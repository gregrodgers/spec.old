...
any resources it may have related to the OpenMP process.
...
the OpenMP process are stopped; otherwise, the OpenMP runtime may be creating and/or destroying
...
device's \emph{nthreads-var} ICV ,
