...
A third-party tool initializes a session working on a OpenMP process or core
...
address space context object for the OpenMP process or core file. The OMPD implementation 
...
of handling the OpenMP process or core file identified by the context. Incompatibility is signaled by a 
