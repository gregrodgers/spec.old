...
%\subsection{Additional internal variables}
\label{subsec:ompd internal variables}
...
\tablelasttail{\hline}
\tablecaption{Additional internal variables\label{tab:OMPD internal varibales}}
\begin{supertabular}{p{1.5in} p{0.5in} p{2.7in}}
...
{\splc{ompd-team-size-var}} & task & return value of \scode{omp_get_num_threads()} when 
executed in this task \\
\end{supertabular}
