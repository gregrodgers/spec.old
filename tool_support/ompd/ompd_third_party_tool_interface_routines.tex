...
\crossreferences
\begin{itemize}
	\item \code{ompd\_address\_space\_context\_t} type, see \specref{sec:ompd_address_space_context_t}.
...
\crossreferences
\begin{itemize}
	\item \code{ompd\_address\_space\_context\_t} type, see \specref{ompd:ompd_address_space_context_t}.
...
ompd_rc_t ompd_get_num_procs (
  ompd_address_space_handle_t *\plc{handle},         /* IN  */
  ompd_word_t                 *\plc{num_processors}   /* OUT */
);
\end{boxedcode}
\cspecificend
}
...
ompd_rc_t ompd_get_thread_limit (
  ompd_address_space_handle_t *\plc{handle},      /* IN  */
  ompd_word_t                 *\plc{num_threads}   /* OUT */
);
\end{boxedcode}
\cspecificend
}
...
ompd\_rc\_t ompd\_get\_thread\_num (
  const ompd\_thread\_handle\_t *\plc{task\_handle},                       /* IN */
  ompd\_word\_t *\plc{val}                                 /* OUT */
);
\end{boxedcode}
\cspecificend
...
ompd\_rc\_t ompd\_get\_schedule (
  ...
  ompd\_word\_t              *\plc{modifier}                              /* OUT */
); 
\end{boxedcode}
\cspecificend
...
ompd\_rc\_t ompd\_release\_display\_control\_vars (
  const char * const *        *\plc{control\_vars}         /* IN */
);
\end{boxedcode}
\cspecificend
...
\argdesc
\plc{control\_vars} is the vector of display control variables to be released.
