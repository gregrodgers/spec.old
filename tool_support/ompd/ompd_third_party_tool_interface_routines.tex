...
\subsubsubsection{\code{ompd_initialize}}
...
\subsubsubsection{\code{ompd_get_version}}
...
\subsubsubsection{\code{ompd_get_version_string}}
...
\subsubsubsection{\code{ompd_finalize}}
...
\subsubsubsection{\code{ompd_process_initialize}}
...
\subsubsubsection{\code{ompd_device_initialize}}
...
\subsubsubsection{\code{ompd_release_address_space_handle}}
...
\subsubsubsection{\code{ompd_get_num_procs}}
...
\subsubsubsection{\code{ompd_get_thread_limit}}
...
\subsubsubsection{\code{ompd_get_thread_in_parallel}}
...
%
%
%\subsubsubsection{\code{ompd_get_master_thread_in_parallel}}
...
\subsubsubsection{\code{ompd_get_thread_handle}}
...
\subsubsubsection{\code{ompd_release_thread_handle}}
...
\subsubsubsection{\code{ompd_thread_handle_compare}}
...
\subsubsubsection{\code{ompd_get_thread_handle_string_id}}
...
\subsubsubsection{\code{ompd_get_thread_id}}
...
\subsubsubsection{\code{ompd_get_current_parallel_handle}}
...
\subsubsubsection{\code{ompd_get_enclosing_parallel_handle}}
...
\subsubsubsection{\code{ompd_get_task_parallel_handle}}
...
\subsubsubsection{\code{ompd_release_parallel_handle}}
...
\subsubsubsection{\code{ompd_parallel_handle_compare}}
...
\subsubsubsection{\code{ompd_get_parallel_handle_string_id}}
...
\subsubsubsection{\code{ompd_get_current_task_handle}}
...
\subsubsubsection{\code{ompd_get_generating_ancestor_task_handle}}
...
\subsubsubsection{\code{ompd_get_scheduling_ancestor_task_handle}}
...
\subsubsubsection{\code{ompd_get_implicit_task_in_parallel}}
...
\subsubsubsection{\code{ompd_release_task_handle}}
...
\subsubsubsection{\code{ompd_task_handle_compare}}
...
\subsubsubsection{\code{ompd_get_task_handle_string_id}}
...
\subsubsubsection{\code{ompd_get_num_threads}}
...
\subsubsubsection{\code{ompd_get_parallel_function}}
...
\subsubsubsection{\code{ompd_get_level}}
...
\subsubsubsection{\code{ompd_get_active_level}}
...
\subsubsubsection{\code{ompd_get_task_function}}
...
\subsubsubsection{\code{ompd_get_max_threads}}
...
\subsubsubsection{\code{ompd_get_thread_num}}
...
\subsubsubsection{\code{ompd_in_parallel}}
...
\subsubsubsection{\code{ompd_in_final}}
...
\subsubsubsection{\code{ompd_get_dynamic}}
...
\subsubsubsection{\code{ompd_get_nested}}
...
\subsubsubsection{\code{ompd_get_max_active_levels}}
...
\subsubsubsection{\code{ompd_get_schedule}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\subsubsubsection{\code{ompd_get_proc_bind}}
...
\subsubsubsection{\code{ompd_is_implicit}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\subsubsubsection{\code{ompd_get_task_frame}}
...
\subsubsubsection{\code{ompd_get_state}}
...
\subsubsubsection{\code{ompd_get_display_control_vars}}
...
\subsubsubsection{\code{ompd_release_display_control_vars}}
