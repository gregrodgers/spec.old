...
\argdesc
A pointer to a descriptive version string will be placed into the location
...
\code{ompd_finalize} before unloading the library.
...
free any remaining resources it may be holding.
