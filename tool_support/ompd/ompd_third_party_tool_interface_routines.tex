...
provided earlier after the call to \code{ompd_initialize}.
...
to which the native thread identifier \plc{thread_id} points represents 
...
%MS: frame_flag no longer exists, now part of frame info
%The \plc{frame_flags} argument 
...
argument specifies the kind of scope provided in \plc{handle}. 
%The \plc{icv_name} argument specifies the name of the requested ICV. 
The \plc{icv_id} argument specifies the ID of the requested ICV. 
On return, the \plc{icv_value}
