...
\begin{itemize}
	\item \code{ompd\_address\_space\_handle\_t} type, see \specref{ompd:ompd_address_space_handle_t}.
	\item \code{ompd\_osthread\_kind\_t} type, see \specref{ompd:ompd_osthread_kind_t}.
	\item \code{ompd\_size\_t} type, see \specref{ompd:ompd_size_t}.
	\item \code{ompd\_thread\_handle\_t} type, see \specref{ompd:ompd_thread_handle_t}.
\end{itemize}
...
identifier. The input argument \plc{sizeof\_osthread} represents the size of the 
thread identifier. The output argument \plc{osthread} is a buffer that represents an operating 
system thread identifier.
...
\begin{itemize}
	\item \code{ompd\_thread\_handle\_t} type, see \specref{ompd:ompd_thread_handle_t}.
	\item \code{omp\_state\_t} type, see \specref{sec:omp_state_t}.
