...
of the OpenMP process or core file.  The OMPD implementation 
...
Contexts are created by a tool and passed to the OMPD implementation. The OMPD 
...
\summary
The  \code{ompd\_get\_thread\_in\_parallel} operation enables a tools to obtain handles for 
