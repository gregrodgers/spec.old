\ompttoolsignature{\code{ompt_start_tool}}
...
\code{ompt_start_tool} return a non-\code{NULL} pointer to an
...
A tool may use its \callbackarg{} \plc{omp_version} to determine
...
The \callbackarg{} \plc{omp_version} 
...
The \callbackarg{} \plc{runtime_version}
is a version string that unambiguously identifies the OpenMP implementation.

\constraints

The \callbackarg{} \plc{runtime_version} must be
