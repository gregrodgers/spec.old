...
for example, \code{omp_state_work_serial},
...
when the thread is 
%performing serial work, parallel work, or a reduction.
...
\code{taskwait} construct or the end of a \code{taskgroup} construct, or late,
...
%locks as well as critical, atomic, and ordered sections.  
%This grouping contains all states used 
...
A thread may enter a mutex wait state early, when a thread encounters a lock
...
%  What does the following sentence mean with regards to the surrounding context? (E. Stotzer)
