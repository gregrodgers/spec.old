...
\subsubsubsection{\code{ompt_initialize_t}}
...
\subsubsubsection{\code{ompt_finalize_t}}
...
\subsubsubsection{\code{ompt_callback_thread_begin_t}}
...
\subsubsubsection{\code{ompt_callback_thread_end_t}}
...
\subsubsubsection{\code{ompt_callback_idle_t}}
...
\subsubsubsection{\code{ompt_callback_parallel_begin_t}}
...
The binding of argument \plc{parallel_data} is the parallel
region that is beginning.

The argument \plc{requested_team_size}
indicates the number of threads requested by the user. 

The argument \plc{invoker} indicates whether the code for the
...
\subsubsubsection{\code{ompt_callback_parallel_end_t}}
...
The argument \plc{invoker} explains whether the execution of the
...
\subsubsubsection{\code{ompt_callback_master_t}}
...
\subsubsubsection{\code{ompt_callback_task_create_t}}
...
The argument \plc{type} indicates the kind of the task: initial,
explicit or target.
...
\subsubsubsection{\code{ompt_callback_task_dependences_t}}
...
\subsubsubsection{\code{ompt_callback_task_dependence_t}}
...
\subsubsubsection{\code{ompt_callback_task_schedule_t}}
...
\subsubsubsection{\code{ompt_callback_implicit_task_t}}
...
The argument \plc{team_size} indicates the number of
threads in the team.

The argument \plc{thread_num} indicates
...
\subsubsubsection{\code{ompt_callback_sync_region_t}}
...
\subsubsubsection{\code{ompt_callback_mutex_acquire_t}}
...
\subsubsubsection{\code{ompt_callback_mutex_t}}
...
\subsubsubsection{\code{ompt_callback_nest_lock_t}}
...
\subsubsubsection{\code{ompt_callback_work_t}}
...
\subsubsubsection{\code{ompt_callback_flush_t}}
...
\subsubsubsection{\code{ompt_callback_target_t}}
...
The binding of argument \plc{task_data} is the target task.
...
\subsubsubsection{\code{ompt_callback_device_load_t}}
...
\subsubsubsection{\code{ompt_callback_device_unload_t}}
...
\subsubsubsection{\code{ompt_callback_target_data_op_t}}
...
\subsubsubsection{\code{ompt_callback_target_map_t}}
...
\subsubsubsection{\code{ompt_callback_target_submit_t}}
...
\subsubsubsection{\code{ompt_callback_buffer_request_t}}
...
\subsubsubsection{\code{ompt_callback_buffer_complete_t}}
...
\subsubsubsection{\code{ompt_callback_control_tool_t}}
...
\subsubsubsection{\code{ompt_callback_cancel_t}}
...
\subsubsubsection{\code{ompt_callback_device_initialize_t}}
...
\subsubsubsection{\code{ompt_callback_device_finalize_t}}
