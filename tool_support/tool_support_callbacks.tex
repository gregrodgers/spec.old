...
\index{ompt_callback_thread_begin_t@{\code{ompt_callback_thread}\-\code{_begin_t}}}
...
\index{ompt_callback_thread_end_t@{\code{ompt_callback_thread}\-\code{_end_t}}}
...
\index{ompt_callback_parallel_begin_t@{\code{ompt_callback_parallel}\-\code{_begin_t}}}
...
\index{ompt_callback_parallel_end_t@{\code{ompt_callback_parallel}\-\code{_end_t}}}
...
\index{ompt_callback_task_create_t@{\code{ompt_callback_task}\-\code{_create_t}}}
...
\index{ompt_callback_task_dependence_t@{\code{ompt_callback_task}\-\code{_dependence_t}}}
...
\index{ompt_callback_task_schedule_t@{\code{ompt_callback_task}\-\code{_schedule_t}}}
...
\index{ompt_callback_implicit_task_t@{\code{ompt_callback_implicit}\-\code{_task_t}}}
...
\index{ompt_callback_sync_region_t@{\code{ompt_callback_sync}\-\code{_region_t}}}
...
\index{ompt_callback_mutex_acquire_t@{\code{ompt_callback_mutex}\-\code{_acquire_t}}}
...
\item \code{ompt_wait_id_t} type signature, see \specref{sec:ompt_wait_id_t}.
\end{itemize}



\subsubsubsection{\hcode{ompt_callback_nest_lock_t}}
\index{ompt_callback_nest_lock_t@{\code{ompt_callback_nest}\-\code{_lock_t}}}
...
\index{ompt_callback_target_code_t@{\code{ompt_callback_device}\-\code{_load_t}}}
...
\index{ompt_callback_target_code_t@{\code{ompt_callback_device}\-\code{_unload_t}}}
...
\index{ompt_callback_target_data_op_t@{\code{ompt_callback_target}\-\code{_data}\-\code{_op_t}}}
...
\index{ompt_callback_target_map_t@{\code{ompt_callback_target}\-\code{_map_t}}}
...
\index{ompt_callback_target_submit_t@{\code{ompt_callback_target}\-\code{_submit_t}}}
...
\index{ompt_callback_buffer_request_t@{\code{ompt_callback_buffer}\-\code{_request_t}}}
...
\index{ompt_callback_buffer_complete_t@{\code{ompt_callback_buffer}\-\code{_complete_t}}}
...
\index{ompt_callback_control_tool_t@{\code{ompt_callback_control}\-\code{_tool_t}}}
...
\index{ompt_callback_flush_t@{\code{ompt_callback_device}\-\code{_initialize_t}}}
...
\index{ompt_callback_flush_t@{\code{ompt_callback_device}\-\code{_finalize_t}}}
