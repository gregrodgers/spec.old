...
\subsubsubsection{\hcode{ompt_callback_idle_t}}
...
The argument \plc{region_flags} includes one or more flags of type 
\code{ompt_sync_region_t} that describe the nature of the 
