...
The \plc{flag} argument indicates whether the code for the region is inlined 
into the application or invoked by the runtime and also whether the region is 
a \code{parallel} or \code{teams} region. Valid values for \plc{flag} are a 
...
The \plc{flag} argument indicates whether the execution of the region is inlined 
into the application or invoked by the runtime and also whether it is a 
\code{parallel} or \code{teams} region.
...
explicit or target.
Values for \plc{flag} are a disjunction of elements in the enum
