...
provided a non-null pointer to an \code{ompt_start_tool_result_t} structure,
...
what thread states and mutual exclusion implementations an OpenMP runtime supports,
...
single callback is provided for a family of events, for example,  a
