...
\subsubsection{Determining Whether a Tool Should be Initialized}
...
\subsubsection{Tool Initialization}
...
\subsubsection{Monitoring Activity on the Host}
...
\subsubsection{Tracing Activity on Target Devices}
...
\subsection{Tool Interface Routine}
