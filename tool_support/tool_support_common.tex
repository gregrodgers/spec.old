...
when it encountered an active cancellation point. The value \code{ompt_task_switch} 
...
\summary
The \code{ompt_hwid_t} is an opaque object representing a hardware identifier for a target device.
