...
An OpenMP implementation should examine the \plc{tool-var} ICV as one of the 
first steps in its initialization. If value of \plc{tool-var} is \plc{disabled}, 
the initialization will continue without checking whether a tool is present and 
the functionality of the OMPT interface will be unavailable as the program executes.
