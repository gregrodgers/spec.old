...
tools. \emph{First-party} tools are linked or loaded directly into the OpenMP program.
...
\subsection{OMPT Interfaces Definitions}
...
The \code{ompt_start_tool} is an external function with \code{C} linkage.
\end{ccppspecific}
