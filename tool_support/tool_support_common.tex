...
\code{ompt_start_tool} the address space, it consults the 
...
The innitializer is invoked prior to the occurrence of any OpenMP \emph{event}.
...
events is amenable to uniform treatment, OMPT provies a single callback for 
