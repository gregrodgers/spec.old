...
\subsubsubsection{\code{ompt_callback_t}}
...
\subsubsubsection{\code{ompt_id_t}}
\label{sec:ompt_id_t} 
...
\subsubsubsection{\code{ompt_data_t}}
...
\subsubsubsection{\code{ompt_device_t}}
...
\subsubsubsection{\code{ompt_device_time_t}}
...
\subsubsubsection{\code{ompt_buffer_t}}
...
\subsubsubsection{\code{ompt_buffer_cursor_t}}
...
\subsubsubsection{\code{ompt_task_dependence_t}}
...
\subsubsubsection{\code{ompt_thread_type_t}}
...
\subsubsubsection{\code{ompt_scope_endpoint_t}}
...
\subsubsubsection{\code{ompt_sync_region_kind_t}}
...
\subsubsubsection{\code{ompt_target_data_op_t}}
...
\subsubsubsection{\code{ompt_work_type_t}}
...
\subsubsubsection{\code{ompt_mutex_kind_t}}
...
\subsubsubsection{\code{ompt_native_mon_flags_t}}
...
\subsubsubsection{\code{ompt_task_type_t}}
...
\subsubsubsection{\code{ompt_task_status_t}}
...
\subsubsubsection{\code{ompt_target_type_t}}
...
\subsubsubsection{\code{ompt_invoker_t}}
...
\subsubsubsection{\code{ompt_target_map_flag_t}}
...
\subsubsubsection{\code{ompt_task_dependence_flag_t}}
...
\subsubsubsection{\code{ompt_cancel_flag_t}}
...
\subsubsubsection{\code{ompt_hwid_t}}
