...
the \code{ompt_set_result_t} enumeration type. If the \code{ompt_set_callback} 
...
the \code{ompt_set_callback} runtime entry point returns.
...
\item \code{ompt_set_callback_t} host callback type signature,
