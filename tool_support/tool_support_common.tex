...
indicates the completion of a task with \code{detach} clause that was waiting for a 
\plc{completion-event}. The value \code{ompt_task_fulfill} indicates that the 
\plc{allow-completion-event} of the task was fulfilled. The value 
