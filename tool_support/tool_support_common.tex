...
\restrictions
The \code{ompt_start_too_result_t} structure has the following restriction:
...
\restrictions
The \code{ompt_record_ompt_t} structure has the following restriction:
...
\summary
When tracing asynchronous activity on devices, tools need identifiers 
to correlate target regions and operations initiated by the host with
