...
Table~\ref{table:record_set} indicates the meaning of the possible return 
codes for \code{ompt_set_trace_ompt}. 
...
Table~\ref{table:record_set} indicates the meaning of the possible return 
codes for \code{ompt_set_trace_native}. 
