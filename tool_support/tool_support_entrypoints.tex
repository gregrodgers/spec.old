...
\restrictions
The \code{ompt_set_trace_ompt} runtime entry point has the following resriction:
...
\restrictions
The \code{ompt_set_trace_native} runtime entry point has the following resriction:
