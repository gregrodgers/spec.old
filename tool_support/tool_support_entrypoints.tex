...
its type. If the function returns a non-null result, it will also set 
\code{*host_op_id} to identify a host-side identifier for the operation 
that is associated with the record. A subsequent call to 
