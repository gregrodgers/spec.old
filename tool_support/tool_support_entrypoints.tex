...
\omptruntimeentrypoint{\code{ompt\_get\_num\_threads\_t}}
\label{sec:ompt_get_num_threads_t}
...
it is determined by the \code{ompt\_get\_num\_procs} runtime entry
point and the time that it is read in the calling context due to
