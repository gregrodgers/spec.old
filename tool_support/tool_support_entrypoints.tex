...
\subsubsubsection{\code{ompt_enumerate_states_t}}
...
\subsubsubsection{\code{ompt_enumerate_mutex_impls_t}}
...
\subsubsubsection{\code{ompt_set_callback_t}}
...
\subsubsubsection{\code{ompt_get_callback_t}}
...
\subsubsubsection{\code{ompt_get_thread_data_t}}
...
\subsubsubsection{\code{ompt_get_num_procs_t}}
...
\subsubsubsection{\code{ompt_get_num_places_t}}
...
\subsubsubsection{\code{ompt_get_place_proc_ids_t}}
...
\subsubsubsection{\code{ompt_get_place_num_t}}
...
\subsubsubsection{\code{ompt_get_partition_place_nums_t}}
...
\subsubsubsection{\code{ompt_get_proc_id_t}}
...
\subsubsubsection{\code{ompt_get_state_t}}
...
\subsubsubsection{\code{ompt_get_parallel_info_t}}
...
\subsubsubsection{\code{ompt_get_task_info_t}}
...
\subsubsubsection{\code{ompt_get_target_info_t}}
...
\subsubsubsection{\code{ompt_get_num_devices_t}}
...
\subsubsubsection{\code{ompt_get_unique_id_t}}
...
\subsubsubsection{\code{ompt_get_device_num_procs_t}}
...
\subsubsubsection{\code{ompt_get_device_time_t}}
...
\subsubsubsection{\code{ompt_translate_time_t}}
...
\subsubsubsection{\code{ompt_set_trace_ompt_t}}
...
\subsubsubsection{\code{ompt_set_trace_native_t}}
...
\subsubsubsection{\code{ompt_start_trace_t}}
...
\subsubsubsection{\code{ompt_pause_trace_t}}
...
\subsubsubsection{\code{ompt_stop_trace_t}}
...
\subsubsubsection{\code{ompt_advance_buffer_cursor_t}}
...
\subsubsubsection{\code{ompt_get_record_type_t}}
...
\subsubsubsection{\code{ompt_get_record_ompt_t}}
...
\subsubsubsection{\code{ompt_get_record_native_t}}
...
\subsubsubsection{\code{ompt_get_record_abstract_t}}
...
\subsubsubsection{\code{ompt_function_lookup_t}}
