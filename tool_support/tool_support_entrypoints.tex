...
indicates whether \emph{dispatching} a callback event leads to its invocation.
...
The argument \plc{event} indicates the event the callback being registered with.
...
The argument \plc{event} indicates the event the callback being inspected upon.
...
includes a filed of a union type that can represent
